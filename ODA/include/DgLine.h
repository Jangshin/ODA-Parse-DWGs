...
public:
  ...
  virtual OdDg::OdDgInfiniteLineType getInfiniteLineType() const;
  virtual void setInfiniteLineType(const OdDg::OdDgInfiniteLineType& uInfiniteLineType);
