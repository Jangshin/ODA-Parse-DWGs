...
/** \details
    This class represents entries in the File Dependency List DWG section.
...
/** \details
    ...
    \remarks
    Every OdDbDatabase instance has an instance of the this class permanently associated with it.
    <group Other_Classes> 
*/
...
public:
  ...
  */
  ...
  /** \details
    ...
    \param walkXRefTree [in]  True to traverse the File Dependency Lists of the referenced drawings.    
  ...
  */
  ...
  /** \details
    Removes the Xref entries from the File Dependency List
