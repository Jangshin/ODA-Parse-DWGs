...
public:
  ...
  */
  ...
  virtual bool getImageData(OdBinaryData& data, OdString* psExtSuffix = NULL) const;
  // obsolete - to avoid problems with old code 
  bool getWmfData(OdBinaryData& data) const { return getImageData(data); }
};
