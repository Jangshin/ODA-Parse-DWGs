...
// ODA_MT_DB_END
  ...
  */
  ...
  enum OsnapMode
  {
    kOsModeEnd      = 1,  //   0x01 // Endpoint
    kOsModeMid      = 2,  //   0x02 // Midpoint
    kOsModeCen      = 3,  //   0x04 // Center
    kOsModeNode     = 4,  //   0x08 // Node
    kOsModeQuad     = 5,  //   0x10 // Quadrant
    kOsModeIntersec = 6,  //   0x20 // Intersection
    kOsModeIns      = 7,  //   0x40 // Insertion point
    kOsModePerp     = 8,  //   0x80 // Perpendicular
    kOsModeTan      = 9,  //  0x100 // Tangent
    kOsModeNear     = 10, //  0x200 // Nearest
    kOsModeApint    = 11, //  0x400 // Apparent intersection
    kOsModePar      = 12, //  0x800 //Parallel
    kOsModeStart    = 13  // 0x1000 //Startpoint
  };
