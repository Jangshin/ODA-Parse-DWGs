...
public:
  ...
  */
  ...
  /** \details
    ...
    This function is called by ODA Drawings API for DGN when access is needed to a
    ...
    kTXApplication          7         ODA Platform Xtension Application file    TX
...
*/
  ...
  */
  virtual bool setThumbnail( const OdString& filename, const OdBinaryData& dibData );
  ...
  */
  virtual bool createThumbnail( const OdString& filename, OdBinaryData& dibData );
  ...
  */
  ...
  /** \details
    ...
    not found by ODA Drawings API for DGN.
  ...
  */
  ...
  virtual OdResult brepBuilder(OdBrepBuilder& builder, BrepType bbType);

  /** \details
  Initializes brep builder for provided arguments.

  \param builder [in,out] Brep builder to initialize.
  \param bbType [in] Type of brep to initialize.
  \param bAcis [in] True for ACIS modeler, false for Parasolid.

  \returns
  Returns eOk on success, or error code on fail.
  */
