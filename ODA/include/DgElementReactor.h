...
public:
  ...
  */
  ...
  2)  One of its member functions either
      ...
      c Calls its setGraphicsModifiedFlag(true)
...
/** \details
    This class is the base class for custom classes that receive notification
    of OdDgElement and OdDgModel element events.
    ...
    <group OdDg_Classes>
*/
class ODRX_ABSTRACT TG_EXPORT OdDgModelReactor : public OdDgElementReactor
{
protected:
  OdDgModelReactor() {}
public:
  ODRX_DECLARE_MEMBERS(OdDgModelReactor);

  /** \details
        Notification function called whenever an model is opened OdDg::kForWrite, a function
        has been called that could modify the gi context linked contents of this element, 
        and this element is now being closed.

        \param pModel [in]  Pointer to the model that is being closed after being modified.
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdDgModelReactor object pointers.
*/
typedef OdSmartPtr<OdDgModelReactor> OdDgModelReactorPtr;
