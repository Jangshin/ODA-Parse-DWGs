...
public:
  ...
  */
  ...
  /** \details
    ...
    \param ucs2wcs [out] function sets this parameter to UCS-to-WCS transform.

    \sa
    \sa <link OdDbDatabase::getUCSORG(), OdDbDatabase::getUCSXDIR(), OdDbDatabase::getUCSYDIR(),
    OdDbDatabase::getPUCSORG(), OdDbDatabase::getPUCSXDIR(), OdDbDatabase::getPUCSYDIR()>
  */
