...
public:
  ...
  virtual void setInvisibleFlag(OdDgGraphicsElement* pSubject, bool bInvisibleFlag, bool doSubents = false);
};
...
public:
  ...
  */
  ...
  virtual OdResult getGeomExtents(const OdDgElement* pSubject, const OdDgElementId& idView, OdUInt32 uExtentFlags, OdGeExtents3d& extents);
  virtual OdResult getGeomExtents(const OdDgElement* pSubject, OdUInt32 uExtentFlags, OdGeExtents3d& extents);
};
