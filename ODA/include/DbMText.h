...
struct OdDbMTextIndent
{
  ...
  OdDbMTextIndent() : paragraphInd(0.0)
    , firstLineInd(0.0) {}
};
...
/** \details
    ...
    <link db_text_multi, Working with Multi-Line Text>
		\sa
    <link OdDbText, OdDbText>, <link OdDbMline, OdDbMline> classes
*/
...
public:
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link OdDbMText::setAttachmentMovingLocation@AttachmentPoint, OdDbMText::setAttachmentMovingLocation() method>
  */
  void setAttachment(
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link OdDbMText::setAttachment@AttachmentPoint, OdDbMText::setAttachment() method>
  */
  ...
  */
  OdString contentsRTF() const;

  /** \details
    Returns a field code in case field exist and returns contents in other cases.
  */
  OdString getTextWithFieldCodes() const;
};
