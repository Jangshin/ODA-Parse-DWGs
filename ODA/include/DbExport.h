...
#ifdef GEOLOCATIONOBJ_DLL_EXPORTS
#define DBGEOLOCATIONOBJ_EXPORT        OD_TOOLKIT_EXPORT
#define DBGEOLOCATIONOBJ_EXPORT_STATIC OD_STATIC_EXPORT
#else
#define DBGEOLOCATIONOBJ_EXPORT OD_TOOLKIT_IMPORT
#define DBGEOLOCATIONOBJ_EXPORT_STATIC OD_STATIC_IMPORT
#endif
