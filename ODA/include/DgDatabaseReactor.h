...
{
public:
  enum OdDgDatabaseActiveProperty
  {
    kActiveModel      = 1,
    kActiveLevel      = 2,
    kActiveColor      = 3,
...
*/
  ...
  \param activeProp [in]  type of property being modified.
...
/** \details
    This template class is a specialization of the OdArray class for OdDgDatabaseReactor object SmartPointers.
*/
typedef OdArray<OdDgDatabaseReactor*, OdMemoryAllocator<OdDgDatabaseReactor*> > OdDgDatabaseReactorArray;
