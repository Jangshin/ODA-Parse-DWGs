...
public:
  ...
  virtual void     setBodyTextStyle( OdUInt32 uTextStyle, bool bUpdateTableDefaults = false );
...
<group OdDg_Classes>
*/
class TG_EXPORT OdDgPrototypeElement : public OdDgElement
{
public:
  ODDG_DECLARE_MEMBERS_INTERNAL( OdDgPrototypeElement );
  ...
  bool                     getSchemaByIndex( OdUInt16 uSchemaIndex, OdDgPrototypeSchema& retSchema ) const;
  bool                     getSchemaByName( const OdString& strName, OdDgPrototypeSchema& retSchema ) const;
  OdInt16                  getSchemaIndexByName(const OdString& strName) const;
...
typedef OdSmartPtr<OdDgPrototypeElement> OdDgPrototypeElementPtr;
