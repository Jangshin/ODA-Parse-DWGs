...
public:
  ...
  virtual bool getDisplayTagFlag() const = 0;
  virtual void setDisplayTagFlag(bool bSet) = 0;

  virtual bool getDefaultFlag() const = 0;
  virtual void setDefaultFlag(bool bSet) = 0;

  virtual bool getConfirmFlag() const = 0;
  virtual void setConfirmFlag(bool bSet) = 0;

  virtual bool getVariableFlag() const = 0;
  virtual void setVariableFlag( bool bSet ) = 0;
};
...
<group OdDg_Classes>
*/
class TG_EXPORT OdDgTagDefinitionDgnOle : public OdRxObject
{
  ODRX_DECLARE_MEMBERS(OdDgTagDefinitionDgnOle);
public:
...
typedef OdSmartPtr<OdDgTagDefinitionDgnOle> OdDgTagDefinitionDgnOlePtr;
/** \details
...
public:
  ...
  OdDgTagDefinitionPtr addDefinition(
    ...
    bool bForceAddDefinitionWithDuplicateName = false);
  OdDgTagDefinitionDgnStorePtr addDgnStoreDefinition(
    const OdBinaryData &data );
  OdDgTagDefinitionDgnOlePtr addDgnOleDefinition(
    const OdBinaryData &data);
