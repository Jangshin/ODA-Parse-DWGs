...
/** \details
    ...
    The web traits are taken from web files, for example *.ies files.
    To get detailed information about photometric data in *.ies files, see the following publication:
...
public:
  ...
  */
  ...
  /** \details
    ...
    \param pWebStream  [in]  Stream pointer.
  */
