...
struct OdGiClipBoundary
{
  ...
  double                m_dFrontClipZ = 0.;       // Distance from target point to FrontClip plane.
  double                m_dBackClipZ = 0.;        // Distance from target point to BackClip plane.
  bool                  m_bClippingFront = false; // Enables front clipping.
  bool                  m_bDrawBoundary = false;  // Enables clipping boundary to be drawn.
  bool                  m_bClippingBack = false;  // Enables back clipping.
};
