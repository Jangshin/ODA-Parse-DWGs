...
/** \details
  The data type that represents a smart pointer to the <link OdGiProgressiveMesh, OdGiProgressiveMesh> object.
*/
...
public:
  ...
  */
  ...
  /** \details
  Releases instance of OdGiProgressiveMeshGenerator
  */
