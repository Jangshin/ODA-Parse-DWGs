...
struct OdGiIntRGB
{
  ...
  /** \details
    ...
    \param _r [in]  Red component of the color.
    \param _g [in]  Green component of the color.
    \param _b [in]  Blue component of the color.
  */
  ...
  */
  ...
  /** \details
    ...
    \param cref [in]  Color as ODCOLORREF definition.
  */
...
class ODGI_EXPORT OdGiPalette : public OdStaticRxObject<OdRxObject>
{
  ...
  public:
    /** \details
      Default constructor for the OdGiPalette class.
    */
    OdGiPalette()
    {
      initPalette();
    ...
    /** \details
      Copy constructor for the OdGiPalette class.
      
      \param obj [in]  Palette to copy.
    */
...
class ODGI_EXPORT OdGiPaletteOverrideHelper
{
  ...
  public:
    /** \details
      Default constructor for the OdGiPaletteOverrideHelper class.
    */
    OdGiPaletteOverrideHelper() : m_pTraits(NULL) {}
    
    /** \details
      Constructor for the OdGiPaletteOverrideHelper class.
      
      \param pTraits    [in]  Subentity traits.
      \param pOverride  [in]  Palette override.
    */
    ...
    /** \details
      Destructor for the OdGiPaletteOverrideHelper class.
    */
