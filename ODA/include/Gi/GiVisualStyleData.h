  ...
  public:
    ...
    */
      ...
      , m_type(kCustom)
    {
      ...
      // Operations
      for (long nOp1 = 0; nOp1 < OdGiVisualStyleProperties::kColor; ++nOp1)
        m_ops[nOp1] = OdGiVisualStyleOperations::kSet;
      for (long nOp2 = OdGiVisualStyleProperties::kColor; nOp2 <= OdGiVisualStyleProperties::kTransparency; ++nOp2)
        m_ops[nOp2] = OdGiVisualStyleOperations::kInherit;
      for (long nOp3 = OdGiVisualStyleProperties::kTransparency + 1; nOp3 < OdGiVisualStyleProperties::kPropertyCount; ++nOp3)
        m_ops[nOp3] = OdGiVisualStyleOperations::kSet;
    }
    /** \details
