...
typedef enum OdGiMrFinalGatheringMode_
{
  ...
  krFinalGatherOn    = 1,
  /** Final gathering usage is defined automatically.*/
  krFinalGatherAuto  = 2
}
OdGiMrFinalGatheringMode; // Represents the final gathering mode. Final gathering enables indirect illumination effects such as color bleeding and can be combined with global illumination.
...
/** \details
    This class allows Gi classes to implement environment map backgrounds.

    Corresponding C++ library: TD_Gi
    <group OdGi_Classes> 
*/
class ODRX_ABSTRACT FIRSTDLL_EXPORT OdGiEnvironmentBackgroundTraits : public OdGiDrawableTraits
{
public:
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdGiEnvironmentBackgroundTraits object pointers.
*/
typedef OdSmartPtr<OdGiEnvironmentBackgroundTraits> OdGiEnvironmentBackgroundTraitsPtr;


/** \details
    This class allows Gi classes to implement custom backgrounds.

    Corresponding C++ library: TD_Gi
    <group OdGi_Classes> 
*/
class ODRX_ABSTRACT FIRSTDLL_EXPORT OdGiCustomBackgroundTraits : public OdGiDrawableTraits
{
public:
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdGiCustomBackgroundTraits object pointers.
*/
typedef OdSmartPtr<OdGiCustomBackgroundTraits> OdGiCustomBackgroundTraitsPtr;
