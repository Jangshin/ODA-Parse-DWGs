...
/** \details
  The data type that represents an array of 2D edges.
*/
...
public:
  ...
  */
  ...
  /** \details
    ...
    kOdGiJoint        4       Joint open silhouette edge
    </table>
...
class OdGiFaceData
{
  ...
  const OdGeVector2d*     m_pFillOffsetDirections;
  const double*           m_pFillOffsetScales;
  const double*           m_pFillDashesScales;
public:
  /** \details
  ...
  */
  OdGiFaceData()
    ...
    , m_pFillOffsetDirections(NULL)
    , m_pFillOffsetScales(NULL)
    , m_pFillDashesScales(NULL)
  {}
  ...
  */
  ...
  /** \details
    ...
    \remarks
    This function does not make a copy of the array, which should have the same number of elements as the 
    mesh or shell with which it is used multiplied by number of pattern lines.
    An incorrect number of elements will have unpredictable or fatal consequences.
    \sa
  ...
  */
  ...
  /** \details
    ...
    \param fillOffsetDirections [in]  Array of fill offset vectors.
    \remarks
    This function does not make a copy of the array, which should have the same number of elements as the
    mesh or shell with which it is used multiplied by number of pattern lines.
    An incorrect number of elements will have unpredictable or fatal consequences.
  */
  void setFillOffsetDirections(
    const OdGeVector2d* fillOffsetDirections)        { m_pFillOffsetDirections = fillOffsetDirections; }

  /** \details
    Sets the face fill offset scales to be used by this object. BIM-specific.

    \param fillOffsetScales [in]  Array of fill offset scale parameters.
    \remarks
    This function does not make a copy of the array, which should have the same number of elements as the
    mesh or shell with which it is used multiplied by number of pattern lines.
    An incorrect number of elements will have unpredictable or fatal consequences.
  */
  void setFillOffsetScales(
    const double* fillOffsetScales)                  { m_pFillOffsetScales = fillOffsetScales; }

  /** \details
    Sets the face fill dashes scales to be used by this object. BIM-specific.

    \param fillDashesScales [in]  Array of fill dashes scale parameters.
    \remarks
    This function does not make a copy of the array, which should have the same number of elements as the
    mesh or shell with which it is used multiplied by number of pattern lines.
    An incorrect number of elements will have unpredictable or fatal consequences.
  */
  void setFillDashesScales(
    const double* fillDashesScales)                  { m_pFillDashesScales = fillDashesScales; }
  ...
  */
  ...
  /** \details
    ...
    This function does not make a copy of the array, which should have the same number of elements as the 
    mesh or shell with which it is used  multiplied by number of pattern lines.
    Writing beyond the array bounds will have unpredictable or fatal consequences.
    \sa
    <link tv_working_with_attributes_fill_patterns, Work with Fill Patterns>
  */
  ...
  */
  ...
  /** \details
    ...
    \returns
    pointer to face fill offset directions.
    \remarks
    This function does not make a copy of the array, which should have the same number of elements as the
    mesh or shell with which it is used multiplied by number of pattern lines.
    Writing beyond the array bounds will have unpredictable or fatal consequences.
  */
  const OdGeVector2d* fillOffsetDirections() const    { return m_pFillOffsetDirections; }

  /** \details
    Returns the array of fill dashes scales used by this object. BIM-specific.

    \returns
    pointer to face fill dashes scales.
    \remarks
    This function does not make a copy of the array, which should have the same number of elements as the
    mesh or shell with which it is used multiplied by number of pattern lines.
    Writing beyond the array bounds will have unpredictable or fatal consequences.
  */
  const double* fillDashesScales() const              { return m_pFillDashesScales; }

  /** \details
    Returns the array of fill offset scales used by this object. BIM-specific.

    \returns
    pointer to face fill offset scales.
    \remarks
    This function does not make a copy of the array, which should have the same number of elements as the
    mesh or shell with which it is used multiplied by number of pattern lines.
    Writing beyond the array bounds will have unpredictable or fatal consequences.
  */
  const double* fillOffsetScales() const              { return m_pFillOffsetScales; }
};
...
public:
  ...
  */
  void setMappingCoords(
    MapChannel channel,
    const OdGePoint3d *coords)             { ODA_VERIFY(channel == kAllChannels); m_pMappingCoords = coords; }
  ...
  */
  ...
  /** \details
    ...
    <link tv_working_with_attributes_materials_mapping, Work with Mapping Properties>
  */
  const OdGePoint3d* mappingCoords(MapChannel channel) const { ODA_VERIFY(channel == kAllChannels); return m_pMappingCoords; }
};
...
*/
  ...
  */
    ...
    const OdCmEntityColor* pColors,
    const OdGeVector3d* pNormals = NULL,
    const OdGsMarker* pSubEntMarkers = NULL) ODRX_FINAL;
...
public:
  /** \details
    ...
    \param geom   [in]  Geometry for which to use clip boundary.
    \param bSave  [in]  Flag that specifies whether to save a clip boundary.
  */
...
public:
  /** \details
    ...
    \param geom   [in]  Geometry for which apply a transformation matrix.
    \param bSave  [in]  Flag that specifies whether to save clip boundary.
  */
