...
class OdGiFaceEdgeDataTraitsSaverBase
{
  ...
  protected:
    OdGiFaceEdgeDataTraitsSaverBase(OdGiSubEntityTraits *pTraits, OdGiConveyorContext *pDrawCtx, OdGsView::RenderMode renderMode)
      : m_pTraits(pTraits), m_pDrawCtx(pDrawCtx), m_renderMode(renderMode), m_components(0), m_prevLayerId(NULL), m_curLayerId(NULL)
    {
    ...
    OdGiFaceEdgeDataTraitsSaverBase()
      : m_pTraits(NULL), m_pDrawCtx(NULL), m_renderMode(OdGsView::k2DOptimized), m_components(0), m_prevLayerId(NULL), m_curLayerId(NULL)
    {
...
class OdGiFaceDataTraitsSaver : protected virtual OdGiFaceEdgeDataTraitsSaverBase
{
  ...
  public:
    OdGiFaceDataTraitsSaver(const OdGiFaceData *pFaceData, OdGiSubEntityTraits *pTraits, OdGiConveyorContext *pDrawCtx,
      ...
      : OdGiFaceEdgeDataTraitsSaverBase(pTraits, pDrawCtx, renderMode), m_pFaceData(pFaceData), m_prevMaterialId(NULL), m_curMaterialId(NULL), m_prevMapper(NULL), m_curMapper(NULL)
    {
