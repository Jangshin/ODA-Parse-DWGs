...
protected:
  ...
  enum Flags
  {
    ...
    kPlotLayerNonPlottable = kFirstFlag << 8,

    kLastFlag              = kPlotLayerNonPlottable
  };
...
public:
  ...
  */
  ...
  /** \details
    ...
    \returns
    Pointer to OdGiSubEntityTraitsData class that stores the traits defined by the owning block.
  */
  ...
  /** \details
    ...
    \param pByBlock       [in]  Pointer to the traits defined by the owning block.
  */
