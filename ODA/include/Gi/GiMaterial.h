...
public:
  ...
  */
  enum ChannelFlags
  {
    ...
    kUseTint        = 0x00100,
    /**Enables roughness material channel. */
    kUseRoughness   = 0x00200,
    /**Enables cutouts material channel. */
    kUseCutouts     = 0x00400,
  ...
  */
  enum ReflectionMethod
  {
    ...
    /**Reflection based onto environment maps. */
...
public:
  ...
  */
  enum Method
  {
    ...
    kOverride = 1,
    /**Uses factor to mix between current drawing color and material color. */
    kBlend    = 2
  };

  /** Null material color (color method is kInherit and blend factor is 1.0). */
  ...
  */
  ...
  /** \details
    ...
    kBlend        2        Uses factor to mix between current drawing color and material color.
    </table>
  */
  ...
  */
  ...
  /** \details
    Sets blending factor to mix between object and material colors.
    \param factor [in]  Blending factor.
  */
  void setBlendFactor(double factor);

  /** \details
    Returns blending factor which may be used to mix between object and material colors.
    \returns
    blending factor as a value of the double type.
  */
...
/** \details
    This class defines scene material texture placeholder.
    Corresponding C++ library: TD_Gi
    <group OdGi_Classes>
*/
...
public:
  ...
  */
  ...
  /** \details
    ...
    \param softness [in] Softness coefficient.
  */
  ...
  */
  ...
  /** \details
    Equality operator for the OdGiMaterialTexture class.
    The objects are equal if:
    * the passed object is an scene texture placeholder.
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdGiSceneTexture object pointers.
*/
...
public:
  ...
  */
  ...
  /** \details
    Default constructor for the OdGiMaterialMap class. Sets the material map source to kFile, all flags as disabled,
    blend factor and brightness to 1.0.
  */
  OdGiMaterialMap();
  ...
  */
  ...
  /** \details
    ...
    \param brightness [in]  Texture brightness.
  ...
  */
  ...
  /** \details
    ...
    \param bInvert [in]  Invert texture image.
  */
  ...
  /** \details
    ...
    \param bInvert [in]  Exchange order of invertion and brightness operations.
  */
  ...
  */
  ...
  /** \details
    ...
    * brightness are equal
    * material map flags are equal
  ...
  */
  ...
  /** \details
    ...
    Assigns map source, file name, blend factor, brightness, flags, mapper and texture to this material map.
