  ...
  public:
    ...
    */
    virtual bool updatePointsData(OdGiPointCloudReceiver *pReceiver, OdUInt32 components = kNoComponents,
                                  ...
                                  OdUInt32 pointSize = 0, OdGiPointCloudScheduler *pExternalScheduler = NULL) const = 0;
};
...
class ODGI_EXPORT OdGiPointCloudXformFilter : public OdGiPointCloudFilter
{
  protected:
    ...
    mutable OdGeBoundBlock3d *m_pBB;
    OdGeMatrix3d m_xForm;
  public:
    ODRX_DECLARE_MEMBERS(OdGiPointCloudXformFilter);
    
    /** \details
      Default constructor for the OdGiPointCloudXformFilter class.
    */
    OdGiPointCloudXformFilter() : m_pBB(NULL) {}
    
    /** \details
      Destructor for the OdGiPointCloudXformFilter class.
    */
    ~OdGiPointCloudXformFilter() { if (m_pBB) delete m_pBB; }
  protected:
  ...
  public:
    /** \details
      Sets transformation matrix for this object.
      
      \param xForm [in]  Tranform matrix to set.
    */
    void setXform(const OdGeMatrix3d &xForm) { m_xForm = xForm; }
    
    /** \details
      Adds transformation matrix for this object.
      
      \param xForm [in]  Transform matrix that is multiplied with current transform matrix.
    */
    void addXform(const OdGeMatrix3d &xForm) { m_xForm.preMultBy(xForm); }
    
    /** \details
      Returns transformation matrix for this object.
      
      \returns
      Reference to OdGeMatrix3d instance representing current transformation matrix.
    */
    const OdGeMatrix3d &getXform() const { return m_xForm; }
    
    /** \details
      Resets current transformation matrix to identity matrix.
    */
    void resetXform() { m_xForm.setToIdentity(); }
    
    /** \details 
      Checks whether transformation matrix of this object is a non-identity transformation matrix.
      
      \returns
      True if this object has non-identity transformation matrix, false otherwise.
    */
    ...
    */
    ...
    /** \details
      Creates an OdGiPointCloudXformFilter object and returns a smart pointer to it.
      
      \param xForm        [in]  Transform matrix to set.
      \param pPrevFilter  [in]  Previous filter.
      \returns
...
class ODGI_EXPORT OdGiPointCloudComponentsFilter : public OdGiPointCloudFilter
{
  protected:
    mutable OdGiPointCloud::ComponentsArray m_comps;
    OdUInt32 m_requestComps = 0;
  public:
    ODRX_DECLARE_MEMBERS(OdGiPointCloudComponentsFilter);
  protected:
    virtual bool filterPointsImpl(OdGiPointCloud::ComponentsRaw *&pPoints, OdUInt32 &nArrays, OdUInt32 &compFlags, const OdGeBoundBlock3d *&pExtents) const;
    virtual bool filterBoundingBoxImpl(OdGeBoundBlock3d &) const { return true; }
  public:
...
/** \details
  Point cloud filter placeholder.

  <group OdGi_Classes> 
*/
class ODGI_EXPORT OdGiPointCloudPlaceholdFilter : public OdGiPointCloudFilter
{
  public:
    // ODRX_DECLARE_MEMBERS(OdGiPointCloudComponentsFilter); // No need own RTTI
  protected:
    virtual bool filterPointsImpl(OdGiPointCloud::ComponentsRaw *& /*pPoints*/, OdUInt32 & /*nArrays*/, OdUInt32 & /*compFlags*/,
                                  const OdGeBoundBlock3d *& /*pExtents*/) const { return true; }
...
/** \details
  ...
  <group OdGi_Classes>
*/
class ODGI_EXPORT OdGiPointCloudScheduler
{
  public:
    enum SchedulerState
    {
      kDisabled = 0, // Scheduler disabled
      kProcessing,   // Scheduler enabled, data processing in progress.
      kStopped       // Scheduler requests abort of data processing.
    };
  protected:
  ...
  public:
    ...
    */
    OdGiPointCloudScheduler() : m_numTasks(0) {}
    ...
    */
    bool onTaskAdded() { return (++m_numTasks) == 1; }
    /** \details
      Unregister task. Returns true if this is last registered task.
    */
    bool onTaskCompleted() { return !(--m_numTasks); }
    /** \details
      Checks number of registered tasks.
    */
    int numTasks() const { return m_numTasks; }
};
...
/** \details
  ...
  <group OdGi_Classes>
*/
class ODGI_EXPORT OdGiPointCloudTimerBasedScheduler : public OdGiPointCloudScheduler
{
  protected:
  ...
  public:
    ...
    */
    OdGiPointCloudTimerBasedScheduler() : m_pTimer(NULL), m_msec(1000), m_eState(kDisabled) {}
    ...
    */
    void setTimerPeriod(OdUInt32 msec) { m_msec = msec; }
    /** \details
      Return timer period in milliseconds.
    */
    OdUInt32 timerPeriod() const { return m_msec; }
