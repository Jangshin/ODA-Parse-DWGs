...
public:
  ...
  */
  OdGiMaterialTraitsData()
    ...
    , m_reflectionMethod(OdGiMaterialTraits::kRayTracedReflections)
    // Visualize extensions
  ...
  */
  void operator =(const OdGiMaterialTraitsData& other)
  {
    ...
    m_reflectionMethod    = other.m_reflectionMethod;
    // Visualize extensions
    ...
    m_cutoutsMap          = other.m_cutoutsMap;
  }
  ...
  */
  bool operator ==(const OdGiMaterialTraitsData& other) const
  {
    ...
    if (m_reflectionMethod    != other.m_reflectionMethod)    return false;
    // Visualize extensions
    ...
    if (m_roughness           != other.m_roughness)           return false;
    if (m_roughnessMap        != other.m_roughnessMap)        return false;
    if (m_cutoutsMap          != other.m_cutoutsMap)          return false;
    return true;
  }
  ...
  */
  bool operator !=(const OdGiMaterialTraitsData& other) const
  {
    ...
    if (m_reflectionMethod    != other.m_reflectionMethod)    return true;
    // Visualize extensions
    ...
    if (m_roughness           != other.m_roughness)           return true;
    if (m_roughnessMap        != other.m_roughnessMap)        return true;
    if (m_cutoutsMap          != other.m_cutoutsMap)          return true;
    return false;
  }
  ...
  */
  ...
  /** \details
    ...
    \param shadowsOpacity             [in]  Coefficient in 0.0-1.0 range.
    \param nonShadowLightsMergeEffect [in]  Value in 0.0-1.0 range that influences ignoring shadows casting by lights.
    \remarks
    The effect percentage value varies from 0 to 1.
    If <c>nonShadowLightsMergeEffect</c> is 0.0 lights can cast shadows on the material, if <c>nonShadowLightsMergeEffect</c> is 1.0 - lights do not cast shadows on the material.
  */
  ...
  /** \details
    ...
    \remarks
    Coefficient is 1.0 by default, which means that shadows opacity fully depends from material opacity.
  */
  ...
  /** \details
    ...
    \remarks
    * Positive override value represents absolute specular highlighting factor.
    * Zero override value disables specular highlighting override.
    * Negative override value provides maximal specular highlighting factor and means that highlighting factor must be taken from Visual Style.
  */
  ...
  */
  ...
  /** \details
    ...
    \param roughnessMap [in]  Roughness map.
    \param strength [in]  Roughness effect strength.
  */
  void setRoughness(const OdGiMaterialMap &roughnessMap, double strength)
  {
    m_roughness = strength;
...
/** \details
    ...
    <group OdGi_Classes>
*/
class ODGI_EXPORT OdGiMaterialTraitsTaker : public OdStaticRxObject<OdGiMaterialTraits>
{
protected:
...
public:
  ...
  */
  ...
  /** \details
    ...
    \param nonShadowLightsMergeEffect [in]  Coefficient in 0.0-1.0 range of light's influence which doesn't allow to cast shadows.
  */
  ...
  /** \details
    ...
    \param nonShadowLightsMergeEffect  [out]  Coefficient in 0.0-1.0 range of light's influence which doesn't allow to cast shadows.
    \returns
  ...
  */
  ...
  /** \details
    ...
    * Positive override value represents absolute specular highlighting factor.
    * Zero override value disables specular highlighting override.
    * Negative override value provides maximal specular highlighting factor and means that highlighting factor must be taken from a visual style.
  */
  void setSpecularHighlightingOverride(double overrideVal)
  {
  ...
  */
  void setRoughness(const OdGiMaterialMap &roughnessMap, double strength)
  {
    m_data.setRoughness(roughnessMap, strength);
  }
  ...
  */
  void roughness(OdGiMaterialMap &roughnessMap, double &strength) const
  {
    m_data.roughness(roughnessMap, strength);
  }
  ...
  */
  ...
  {
    m_data.setReflectionMethod(method);
  }
  ...
  */
  ...
  {
    return m_data.reflectionMethod();
  }
...
/** \details
    ...
    <group OdGi_Classes>
*/
class ODGI_EXPORT OdGiMaterialTraits_Stub : public OdStaticRxObject<OdGiMaterialTraits>
{
public:
  ODRX_USING_HEAP_OPERATORS(OdGiMaterialTraits);
  ...
  */
  ...
  void setReflectionMethod(ReflectionMethod /*method*/) { }
  ReflectionMethod reflectionMethod() const { return kRayTracedReflections; }
};
