...
class FIRSTDLL_EXPORT OdGiSelectionStyle
{
  public:
    ...
    */
    class ColorMask
    {
      ...
      public:
        /** \details
          Default constructor for the ColorMask class. Creates a transparent color mask.
        */
        ...
        */
        ...
        /** \details
          ...
          \returns
          Transparency value in range [0-255] where 0 - fully opaque, 255 - fully transparent.
        */
        ...
        */
        ...
        /** \details
          Checks whether color mask is visible.
          \returns
          true in case if color mask is visible (i. e. not fully transparent), false otherwise.
        */
        bool isVisible() const { return m_transparency < 255; }
        /** \details
          Checks whether color mask is completely opaque.
          \returns 
          true if color mask is completely opaque, false otherwise.
        */
        ...
        */
        ...
        /** \details
          Equality operator for the ColorMask class.
          
          \param cm2 [in]  Color mask to compare.
          \returns
          true if all the following conditions are met:
          * Color mask transparency values are equal.
          * Color mask colors are equal.
        */
        bool operator ==(const ColorMask &cm2) const
        { return (transparency() == cm2.transparency()) && (!isVisible() || color() == cm2.color()); }
        
        /** \details
          Inequality operator for the ColorMask class.
      ...
      public:
        ...
        */
        ...
        /** \details
          ...
          \returns 
          true in case if any type of visual effect (like stippling pattern or color mask) is
        ...
        */
        ...
        /** \details
          ...
          \param secStyle [in]  Element style to compare.
          \returns
          true if all the following conditions are met:
          * Element flags are equal.
          * Color masks are equal.
        */
    ...
    class EdgeStyle : public ElementStyle
    {
      public:
        ...
        */
        enum Mode
        {
          kExistEdges,   // Draw existing edges if they are enabled.
          kIsolineEdges, // Draw isolines for 3d objects and existing edges for others.
          kContourEdges  // Draw contours for 3d objects and existing edges for others.
        };
      protected:
        enum EdgeFlags
        {
      ...
      public:
        ...
        */
        ...
        /** \details
          ...
          \returns
          true in case if any type of visual effect (like color mask or edges width) is
        ...
        */
        ...
        /** \details
          ...
          \param secStyle [in]  Edge style to compare.
          \returns
          true if all the following conditions are met:
          * Element styles are equal.
          * Lineweight extension value in pixels are equal.
        */
      ...
      public:
        ...
        */
        ...
        /** \details
          ...
          \returns 
          true in case if any type of visual effect (like color mask, for example) is
        ...
        */
        ...
        /** \details
          ...
          \param secStyle [in]  Style entry to compare.
          \returns
          true if all the following conditions are met:
          * Edge styles are equal.
          * Face styles are equal.
        */
  ...
  public:
    ...
    */
    ...
    /** \details
      Sets up selection style to display classing stippling pattern highlighting visual effect. Renders original object
      with stippling pattern. Doesn't render any geometry on top.
    */
    void setForStippling() { styleFor(false).setForStippling(); styleFor(true).setAsDisabled(); sync3d(); }
    /** \details
      Sets up selection style for default color masking behavior. Draws semi-transparent faces and edges on top of scene geometry.
      Additionally enables edges width extension and rendering of 3d geometry isolines.
    */
