...
/** \details
    This raster image transformer class rotates an image by 90 degrees.
    ...
    <link gi_raster_images, Work with Raster Images>
*/
class ODGI_EXPORT OdGiHorizontalToVerticalRasterTransformer : public OdGiRasterImageWrapper
{
protected:
  bool m_bCcw;
public:
  /** \details
    Default constructor for the OdGiHorizontalToVerticalRasterTransformer class.
  */
  OdGiHorizontalToVerticalRasterTransformer();
  
  /** \details
    Destructor for the OdGiHorizontalToVerticalRasterTransformer class.
  */
  virtual ~OdGiHorizontalToVerticalRasterTransformer();

  /** \details
    Creates a new image rotation transformer.
    \param pOrig [in]  Original raster image pointer.
    \param bCcw [in]  Set to true for counterclockwise rotation.
    \returns
    smart pointer to the created object.
  */
