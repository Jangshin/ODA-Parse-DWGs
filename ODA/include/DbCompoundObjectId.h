...
public:
    ...
    */
    ...
    OdDbCompoundObjectId(const OdDbCompoundObjectId& other, OdDbDatabase* pHostDb = 0);
    OdDbCompoundObjectId(const OdDbObjectId& id, OdDbDatabase* pHostDb = 0);
    OdDbCompoundObjectId(const OdDbObjectId& id, const OdDbObjectIdArray& path, OdDbDatabase* pHostDb = 0);
protected:
