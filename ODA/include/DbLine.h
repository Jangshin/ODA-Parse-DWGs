...
/** \details
  ...
  <link db_line, Working with Lines>
	\sa
  <link OdDbXline, OdDbXline>, <link OdDbRay, OdDbRay>, <link OdDbMline, OdDbMline> classes
*/
...
public:
  ...
  */
  ...
  /** \details
    ...
    <link db_line_specific, Specific Line Properties>
		\sa
    <link OdDbLine::setStartPoint@OdGePoint3d&, OdDbLine::setStartPoint() method>
		\sa
		<link OdDbLine::endPoint@const, OdDbLine::endPoint() method> 
  */
  ...
  /** \details
    ...
    <link db_line_specific, Specific Line Properties>
		\sa
    <link OdDbLine::startPoint@const, OdDbLine::startPoint() method>
		\sa
    <link OdDbLine::setEndPoint@OdGePoint3d&, OdDbLine::setEndPoint() method>
  */
  ...
  */
  ...
  /** \details
    ...
    <link db_line_specific, Specific Line Properties>
		\sa
    <link OdDbLine::setThickness@double, OdDbLine::setThickness() method>
  */
  ...
  /** \details
    ...
    <link db_line_specific, Specific Line Properties>
		\sa
    <link OdDbLine::thickness@const, OdDbLine::thickness() method>
  */
  ...
  /** \details
    ...
    <link db_line_specific, Specific Line Properties>
		\sa
    <link OdDbLine::setNormal@OdGeVector3d&, OdDbLine::setNormal() method>
  */
  ...
  /** \details
    ...
    <link db_line_specific, Specific Line Properties>
		\sa
    <link OdDbLine::normal@const, OdDbLine::normal() method>
  */
  ...
  /** \details
    ...
    <link db_line, Working with Lines>
		\sa
    <link OdDbLine::getPlane@OdGePlane&@OdDb::Planarity&@const, OdDbLine::getPlane() method>
		\sa
  ...
  */
  ...
  /** \details
    ...
    <link db_line, Working with Lines>
		\sa
    <link OdDbLine::isPlanar@const, OdDbLine::isPlanar() method>
		\sa
  ...
  */
  ...
  OdResult getOffsetCurvesGivenPlaneNormal(const OdGeVector3d& normal,
    double offsetDist,
    OdRxObjectPtrArray& offsetCurves) const override;
