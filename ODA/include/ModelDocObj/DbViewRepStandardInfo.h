...
public:
  ...
  OdDbViewRepStandardInfo()
    : dpiResolutionType(OdDbViewRepStandard::k100dpi)
    , projectionType(OdDbViewRepStandard::kFirstAngle)
    , sectionThreadEndDisplayType(OdDbViewRepStandard::kClosedThreadEnd)
    , circularThreadEdgeDisplayType(OdDbViewRepStandard::kClosedCircularThreadEdge)
    , previewDisplayType(OdDbViewRepStandard::kShadedPreview)
    , synergyVersion(OdDbViewRepStandard::kVersion1)
  {
  }
};
