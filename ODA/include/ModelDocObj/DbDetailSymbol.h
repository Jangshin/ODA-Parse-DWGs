...
public:
  ...
  */
  ...
  /** \details
    Calculates model edge border extents.
  
    \param extents [out] Calculated extents.
    \returns eOk - if successful, corresponding error type - otherwise.
  */
  OdResult modelEdgeBorderExtents(OdGeExtents3d& extents) const;

  /** \details
    Gets the identifier position of this Detail Symbol entity.
...
protected:
  /** \details
      Notification from detail view style. Invalidates Gs cache.
  */
