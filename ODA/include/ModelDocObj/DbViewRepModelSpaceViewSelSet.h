...
public:
  ...
  static bool getSelectedObjIdsForView(const OdDbObjectId&, OdDbObjectIdArray&);

  void setSelectedObjIds(const OdDbObjectIdArray& ids);
  const OdDbObjectIdArray& selectedObjIds() const;
