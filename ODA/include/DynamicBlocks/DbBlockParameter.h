...
typedef OdArray< OdDbBlockGripPtr, OdObjectsAllocator<OdDbBlockGripPtr> > OdDbBlockGripPtrArray;
...
public:
  ...
  void getGrips(OdDbBlockGripPtrArray&, OdDb::OpenMode = OdDb::kForRead);
