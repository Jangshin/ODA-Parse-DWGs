...
#include "DbParameterInterface.h"
...
public:
  ...
  */
  ...
  /** \details
    Gets the parameter description for the given column.
    \param column [in] Column index.
    \param block [in] Dynamic block reference.
  */
  ...
  */
  ...
  /** \details
    ...
    \param row [in] New current row index.
  */
  bool setCurrentRow(int row);
  
  /** \details
    Gets the parameter id for the given column.
    \param column [in] Column index.
  */
  OdDbObjectId getColumnParam(int column) const;
  
  /** \details
    Returns true if the values meet the parameters constraints.
  */
  bool isValid() const;
};
