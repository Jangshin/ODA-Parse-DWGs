...
public:
  ...
  */
  ...
  /** \details
    ...
    \param arrCoordSys [out] Array of pointers to the new CRS objects.
    
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  virtual OdResult createAll(const OdGePoint3d& geoPt, OdArray<OdDbGeoCoordinateSystemPtr>& arrCoordSys) const = 0;
  ...
  */
  virtual OdResult createAll(OdArray<OdDbGeoCoordinateSystemPtr>& arrCoordSys, const OdDbGeoCoordinateSystemCategory* pCategory = NULL) const = 0;
};
/** \details
