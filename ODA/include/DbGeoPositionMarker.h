...
public:
  ...
  */  
  ...
  \param position [in] A new value of the geographical location coordinates (where x, y, z are longitude, latitude and altitude) that should be set.
  ...
  */
  ...
  \param alt [out] A reference to a double variable to store the altitude value.
  ...
  */  
  ...
  \param alt [in] A double value of the altitude.
