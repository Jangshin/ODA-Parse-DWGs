...
public:
  ...
  */
  ...
  /** \details
    ...
    \param value [in] A new value of the offset.
  */
  ...
  */
  ...
  /** \details
    Sets the font type for carousel buttons. The font type is represented with one of <link OdPdfPublish::Text::StandardFontsType,  predefined fonts>.
  ...
  */
  ...
  /** \details
    Sets the <link OdPdfPublish::CarouselButtons::Alignment, alignment> for carousel buttons.

    \param alignment [in] A new <link OdPdfPublish::CarouselButtons::Alignment, alignment> value.

    \remarks
    The <link OdPdfPublish::CarouselButtons::Alignment, alignment> has an effect only if all carousel buttons can be displayed without scrolling.

    \sa
    * <link OdPdfPublish::CarouselButtons::Alignment, CarouselButtons::Alignment enumeration>
    * <link OdPdfPublish::OdAnnotation::getCarouselButtonsAlignment@CarouselButtons::Alignment&@const, getCarouselButtonsAlignment() method>
  */
  ...
  */
  ...
  /** \details
    ...
    \param value [out] A placeholder for the value of the offset.
  */
  void getCarouselButtonsOffset(OdUInt32& value) const;

  /** \details
    Returns the current font parameters of carousel buttons.
    The method fills passed values and returns them to a calling subroutine.

    \param storageType  [out] A placeholder for the <link OdPdfPublish::Text::StorageType, storage type>.
    \param fontType     [out] A placeholder for the <link OdPdfPublish::Text::StandardFontsType, font type>.
    ...
    \param language     [out] A placeholder for the <link OdPdfPublish::Text::Language, font language>.
  ...
  */
  ...
  /** \details
    Retrieves the current <link OdPdfPublish::CarouselButtons::Alignment, alignment> for carousel buttons.
    The method fills the passed value of the <link OdPdfPublish::CarouselButtons::Alignment, Alignment enumeration> with the current alignment and returns it to a calling subroutine.

    \param alignment  [out] A placeholder for the <link OdPdfPublish::CarouselButtons::Alignment, alignment> value.

    \sa
    * <link OdPdfPublish::CarouselButtons::Alignment, CarouselButtons::Alignment enumeration>
    * <link OdPdfPublish::OdAnnotation::setCarouselButtonsAlignment@CarouselButtons::Alignment, setCarouselButtonsAlignment() method>
  */
