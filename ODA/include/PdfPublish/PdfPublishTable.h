...
public:
  ...
  */  
  ...
  /** \details 
    ...
    \param row        [in] A table row index. Can accept values from 0 to the table row quantity - 1.
    \param column     [in] A table column index. Can accept values from 0 to the table column quantity - 1.
    \param text       [in] A smart pointer to an <link OdPdfPublish::OdText, OdText object> that should be added.
    \param rotation   [in] A rotation angle value to be set.
    \param alignment  [in] A alignment for text in table cells value to be set.
    
    \sa
    * <link OdPdfPublish::OdText, OdText class>
    * <link OdPdfPublish::Table::TextAlignment, Table::TextAlignment enumeration>
  */  
  ...
  /** \details
    ...
    \param left      [in] A left margin for a table text cell.
    \param right     [in] A right margin for a table text cell.
    \param bottom    [in] A bottom margin for a table text cell.
    \param top       [in] A top margin for a table text cell.
  */
  ...
  */
  ...
  /** \details
    ...
    \param rotation  [out] A placeholder for the <link OdPdfPublish::OdText, text label> rotation angle.
    \param alignment [out] A placeholder for <link OdPdfPublish::Table::TextAlignment, alignment> for text in table cells value to be set.
    
    \returns Returns a smart pointer to the <link OdPdfPublish::OdText, text label> contained in the table cell. If the cell does not contain a text label, a null pointer is returned.
  ...
  */
  ...
  /** \details
    ...
    \param left      [out] A placeholder for left margin for a table text cell.
    \param right     [out] A placeholder for right margin for a table text cell.
    \param bottom    [out] A placeholder for bottom margin for a table text cell.
    \param top       [out] A placeholder for top margin for a table text cell.
  */
