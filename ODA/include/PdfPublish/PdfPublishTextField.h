...
public:
  ...
  */
  ...
  /** \details
    Sets the font parameters of the text field. 
    
    \param fontName  [in] A new font name.
    \param fontStyle [in] A new <link OdPdfPublish::Text::FontStyle, font style>.
    \param language  [in] A new <link OdPdfPublish::Text::StandardFontsType, font language> for the text label.
  ...
  */
  ...
  /** \details
    ...
    \param language     [out] A placeholder for the font language that should be used for displaying the text field caption.
