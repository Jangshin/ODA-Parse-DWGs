...
public:
  ...
  */
  ...
  /** \details
    Sets the parameters of the signature field font. 
  ...
  */
  ...
  /** \details
    ...
    \param fontType     [out] A placeholder for the <link OdPdfPublish::Text::StandardFontsType, font type> that should be used for displaying the signature field caption.
    \param fontName     [out] A placeholder for the font name that should be used for displaying the signature field caption.
    \param fontStyle    [out] A placeholder for the <link OdPdfPublish::Text::FontStyle, font style> that should be used for displaying the signature field caption.
    \param language     [out] A placeholder for the <link OdPdfPublish::Text::Language, font language> that should be used for displaying the signature field caption.
