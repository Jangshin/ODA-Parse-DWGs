...
public:
  ...
  */
  ...
  /** \details
    Sets the parameters of the checkbox font. 
  ...
  */
  ...
  /** \details
    ...
    \param fontType     [out] A placeholder for the <link OdPdfPublish::Text::StandardFontsType, font type> that should be used for the checkbox.
    \param fontName     [out] A placeholder for the font name that should be used for the checkbox.
    \param fontStyle    [out] A placeholder for the <link OdPdfPublish::Text::FontStyle, font style> that should be used for the checkbox.
    \param language     [out] A placeholder for the <link OdPdfPublish::Text::Language, font language> that should be used for the checkbox.
