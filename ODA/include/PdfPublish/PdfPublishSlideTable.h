...
/** \details
  ...
  A slide table contains a scrollbar (by default) or two specific buttons (if their names are specified with the <link OdPdfPublish::OdSlideTable::setButtons@const_OdString&@const_OdString&, setButtons() method>):
...
public:
  ...
  */
  ...
  /** \details 
    ...
    The size of the slide table is determined by the location rectangle passed to the <link OdPdfPublish::OdPage::addSlideTable@const_OdSlideTablePtr&@const_OdRect&, addSlideTable()> method of the 
