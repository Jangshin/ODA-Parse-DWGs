...
public:
  ...
  */
  ...
  /** \details
    ...
    \param storageType  [out] A placeholder for the <link OdPdfPublish::Text::StorageType, font storage type>.
    \param fontType     [out] A placeholder for the <link OdPdfPublish::Text::StandardFontsType, font type> that should be used for displaying drop-down list items.
    \param fontName     [out] A placeholder for the font name that should be used for displaying drop-down list items.
    \param fontStyle    [out] A placeholder for the <link OdPdfPublish::Text::FontStyle, font style> that should be used for displaying drop-down list items.
    \param language     [out] A placeholder for the <link OdPdfPublish::Text::Language, font language> that should be used for displaying drop-down list items.
