...
public:
  ...
  */
  ...
  /** \details
    ...
    \remarks 
    If you use one of the <link !!OVERLOADED_Methods_addCADReference_OdPdfPublish::OdPage, addCADReference()> methods of the <link OdPdfPublish::OdPage, OdPage class> to add a CAD reference to a page, this method has no effect.
  */
  ...
  */
  ...
  /** \details
    Sets the bookmarks support flag.
    This flag determines whether bookmarks are supported (equals true) or not (equals false).
    \param state [in] A new flag value.
  */
  void setEnableBookmarks(const bool state);

  /** \details
    Sets the CAD reference name.
    \param name [in] A <exref target="https://docs.opendesign.com/tkernel/OdString.html">string</exref> that contains the new CAD reference name.
    \remarks
    The name is the top-level bookmark name for the CAD reference object.
  */
  void setCADReferenceName(const OdString& name);
  ...
  */
  ...
  /** \details
    Returns the current value of the bookmarks flag.
    This flag determines whether bookmarks are supported (equals true) or not (equals false).
    \param state  [out] A placeholder for the flag value.
  */
  void getEnableBookmarks(bool& state) const;

  /** \details
    Returns the CAD reference name.
    The method fills a passed <exref target="https://docs.opendesign.com/tkernel/OdString.html">string</exref> object with the current name of the CAD reference and returns it to a calling subroutine.
    \param name [out] A placeholder for the CAD reference name.
    \remarks
    The name is the top-level bookmark name for the CAD reference object.
  */
