...
public:
  ...
  virtual OdGePoint2dArray getBoundary() const;
  virtual void setBoundary(const OdGePoint2dArray& boundaryArr);

  virtual bool initFromGiRasterImage(const OdGiRasterImage* pGiImage);
  ...
  virtual OdGiRasterImagePtr getImage();
