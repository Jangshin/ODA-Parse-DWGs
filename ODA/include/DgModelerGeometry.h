...
public:
  enum
  {
    ...
    kOptionsMask    = 0x00f00000,
    kXB_SkipTextHdr = 0x00400000,
    kXB_HardConvert = 0x00800000,
...
public:  
  ...
  virtual OdResult getGeomExtents(OdGeExtents3d& ext) = 0;
  ...
  virtual void setMaterialCallback( OdMaterialCallback* pCallback ) = 0;
};
