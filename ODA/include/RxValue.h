...
/** \details
  OdRxValueType specialization for 'OdGeDoubleArray' value type.
*/
ODRX_DECLARE_VALUE_TYPE(OdGeDoubleArray, FIRSTDLL_EXPORT)
...
/** \details
  OdRxValueType specialization for 'OdIntArray' value type.
*/
ODRX_DECLARE_VALUE_TYPE(OdIntArray, FIRSTDLL_EXPORT)
...
/** \details
  OdRxValueType specialization for 'OdInt64Array' value type.
*/
ODRX_DECLARE_VALUE_TYPE(OdInt64Array, FIRSTDLL_EXPORT)
...
/** \details
  OdRxValueType specialization for 'OdUInt64Array' value type.
*/
ODRX_DECLARE_VALUE_TYPE(OdUInt64Array, FIRSTDLL_EXPORT)
...
/** \details
  OdRxValueType specialization for 'OdArray<OdGeDoubleArray>' value type.
*/
ODRX_DECLARE_VALUE_TYPE(OdArray<OdGeDoubleArray>, FIRSTDLL_EXPORT)
...
/** \details
  OdRxValueType specialization for 'OdArray<OdIntArray>' value type.
*/
ODRX_DECLARE_VALUE_TYPE(OdArray<OdIntArray>, FIRSTDLL_EXPORT)
