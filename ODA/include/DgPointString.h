...
public:
  ...
  virtual OdResult      addVertex     ( const OdGePoint2d& point, const OdGeMatrix2d& rotation );
...
public:
  ...
  virtual OdResult        addVertex     ( const OdGePoint3d& point, const OdGeQuaternion& rotation );
