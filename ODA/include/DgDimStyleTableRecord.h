...
public:
  ...
  */
  ...
  virtual bool getStackedFractionFlag() const;
  // Set enable stacked fraction flag.
  virtual void setStackedFractionFlag(const bool bSetFlag);
  ...
  // Get annotation scale flag for dimension.
  virtual bool getAnnotationScaleFlag() const;
  // Set annotation scale flag for dimension.
  ...
  virtual OdDgDimNote::NoteTerminatorType getNoteTerminator() const;
  // Set terminator type for note dimension.
  virtual void setNoteTerminator( const OdDgDimNote::NoteTerminatorType iTerm );
