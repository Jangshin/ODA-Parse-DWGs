...
public:
  ...
  virtual bool hasLevelNameLastModificationTime() const;
  virtual OdTimeStamp getLevelNameLastModificationTime() const;
  virtual void setLevelNameLastModificationTime(bool bReset, const OdTimeStamp& timeToSet);
...
//  OdBinaryData getTransparency() const;
  ...
  /** \remarks
    The methods are deprecated now. Use OdDgMaterialAssignmentElementPE methods to work with material
  assignments.
  */
