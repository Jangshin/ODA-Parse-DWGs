...
public:
  ...
  */
  ...
  /** \details
    For ODA Drawings SDK internal use only. 
  */
  ...
  */
  ...
  OdDgElementId& operator = (const OdDgElementId& objectId) = default;
  ...
  /** \details
    For ODA Drawings API for DGN internal use only.
  */
...
//????  inline OdDbStub* operator -> () const { return (OdDbStub*)m_Id; }
  ...
  /** \details
    For ODA Software internal use only. 
  */
  ...
  */
  ...
  /** \details
    ...
    \param pObj [out] SmartPointer to the opened object if successful, otherwise a null SmartPointer
