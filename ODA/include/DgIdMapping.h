...
public:
  /** \param source [in]  OdDgIdPair to be copied.
    ...
    \param bPrimary [in]  Value element is primary.
  */
  OdDgIdPair()
    : m_bCloned(false), m_bOwnerXlated(false), m_bPrimary(true){ }
  ...
  */
  ...
  \param bPrimary [in]  If value is primary.
  */
  void setPrimary(
    bool bPrimary) { m_bPrimary = bPrimary; }
