 ...
 */
  ...
  */
  ...
  enum AutoTransform
  {
    ...
    kPredefinedBim        = 0x8, // Uses predefined uv coordinates for mapping (BIM-specific case).
  };
  ...
  */
  ...
  \param 
    isFaceForward [in] Face forward flag.
    origin       [out] Receives filling origin attribute.
    rotAngle     [out] Receives rotation angle attribute.
    swapUv       [out] Receives uv swapping flag.
    scaleUv      [out] Receives uv scaling parameters.
    uDerScale    [out] Receives u derivative scaling parameter.
  */
  ...
  */
  ...
  /** \details
    BimRv specific. Retrieves materials attributes for the face.

  \param
    origin [out] Receives material origin attribute.
    angle [out] Receives material angle attribute.
