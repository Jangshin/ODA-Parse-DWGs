...
public:  
  ...
  */
  ...
  //DOM-IGNORE-BEGIN
  OdBrElement2d(const OdBrElement2d&) = default;
  OdBrElement2d& operator=(const OdBrElement2d&) = default;
  OdBrElement2d(OdBrElement2d&&) = default;
  OdBrElement2d& operator=(OdBrElement2d&&) = default;
  //DOM-IGNORE-END
#endif
