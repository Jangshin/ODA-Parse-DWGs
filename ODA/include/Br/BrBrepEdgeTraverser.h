...
public:
  ...
  //DOM-IGNORE-BEGIN
  OdBrBrepEdgeTraverser(const OdBrBrepEdgeTraverser&) = default;
  OdBrBrepEdgeTraverser& operator=(const OdBrBrepEdgeTraverser&) = default;
  OdBrBrepEdgeTraverser(OdBrBrepEdgeTraverser&&) = default;
  OdBrBrepEdgeTraverser& operator=(OdBrBrepEdgeTraverser&&) = default;
  //DOM-IGNORE-END
#endif
