...
public:
  ...
  //DOM-IGNORE-BEGIN
  OdBrBrepVertexTraverser(const OdBrBrepVertexTraverser&) = default;
  OdBrBrepVertexTraverser& operator=(const OdBrBrepVertexTraverser&) = default;
  OdBrBrepVertexTraverser(OdBrBrepVertexTraverser&&) = default;
  OdBrBrepVertexTraverser& operator=(OdBrBrepVertexTraverser&&) = default;
  //DOM-IGNORE-END
#endif
