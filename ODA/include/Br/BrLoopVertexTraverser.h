...
public:
  ...
  //DOM-IGNORE-BEGIN
  OdBrLoopVertexTraverser(const OdBrLoopVertexTraverser&) = default;
  OdBrLoopVertexTraverser& operator=(const OdBrLoopVertexTraverser&) = default;
  OdBrLoopVertexTraverser(OdBrLoopVertexTraverser&&) = default;
  OdBrLoopVertexTraverser& operator=(OdBrLoopVertexTraverser&&) = default;
  //DOM-IGNORE-END
#endif
