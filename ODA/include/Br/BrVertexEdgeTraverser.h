...
public:
  ...
  //DOM-IGNORE-BEGIN
  OdBrVertexEdgeTraverser(const OdBrVertexEdgeTraverser&) = default;
  OdBrVertexEdgeTraverser& operator=(const OdBrVertexEdgeTraverser&) = default;
  OdBrVertexEdgeTraverser(OdBrVertexEdgeTraverser&&) = default;
  OdBrVertexEdgeTraverser& operator=(OdBrVertexEdgeTraverser&&) = default;
  //DOM-IGNORE-END
#endif
