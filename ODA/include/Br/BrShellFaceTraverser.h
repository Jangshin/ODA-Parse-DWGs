...
public:
  ...
  //DOM-IGNORE-BEGIN
  OdBrShellFaceTraverser(const OdBrShellFaceTraverser&) = default;
  OdBrShellFaceTraverser& operator=(const OdBrShellFaceTraverser&) = default;
  OdBrShellFaceTraverser(OdBrShellFaceTraverser&&) = default;
  OdBrShellFaceTraverser& operator=(OdBrShellFaceTraverser&&) = default;
  //DOM-IGNORE-END
#endif
