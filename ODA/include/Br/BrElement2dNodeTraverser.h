...
public:
  ...
  */
  ...
  //DOM-IGNORE-BEGIN
  OdBrElement2dNodeTraverser(const OdBrElement2dNodeTraverser&) = default;
  OdBrElement2dNodeTraverser& operator=(const OdBrElement2dNodeTraverser&) = default;
  OdBrElement2dNodeTraverser(OdBrElement2dNodeTraverser&&) = default;
  OdBrElement2dNodeTraverser& operator=(OdBrElement2dNodeTraverser&&) = default;
  //DOM-IGNORE-END
#endif
