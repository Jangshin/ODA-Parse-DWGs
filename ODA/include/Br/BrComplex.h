...
public:
  ...
  //DOM-IGNORE-BEGIN
  OdBrComplex(const OdBrComplex&) = default;
  OdBrComplex& operator=(const OdBrComplex&) = default;
  OdBrComplex(OdBrComplex&&) = default;
  OdBrComplex& operator=(OdBrComplex&&) = default;
  //DOM-IGNORE-END
#endif
