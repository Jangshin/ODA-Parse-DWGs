...
public:
  ...
  */
  ...
  //DOM-IGNORE-BEGIN
  OdBrMesh2dElement2dTraverser(const OdBrMesh2dElement2dTraverser&) = default;
  OdBrMesh2dElement2dTraverser& operator=(const OdBrMesh2dElement2dTraverser&) = default;
  OdBrMesh2dElement2dTraverser(OdBrMesh2dElement2dTraverser&&) = default;
  OdBrMesh2dElement2dTraverser& operator=(OdBrMesh2dElement2dTraverser&&) = default;
  //DOM-IGNORE-END
#endif
