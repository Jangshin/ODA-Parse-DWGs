...
public:
  ...
  //DOM-IGNORE-BEGIN
  OdBrEdgeLoopTraverser(const OdBrEdgeLoopTraverser&) = default;
  OdBrEdgeLoopTraverser& operator=(const OdBrEdgeLoopTraverser&) = default;
  OdBrEdgeLoopTraverser(OdBrEdgeLoopTraverser&&) = default;
  OdBrEdgeLoopTraverser& operator=(OdBrEdgeLoopTraverser&&) = default;
  //DOM-IGNORE-END
#endif
