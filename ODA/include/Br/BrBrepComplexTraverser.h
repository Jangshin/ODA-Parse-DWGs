...
public:
  ...
  //DOM-IGNORE-BEGIN
  OdBrBrepComplexTraverser(const OdBrBrepComplexTraverser&) = default;
  OdBrBrepComplexTraverser& operator=(const OdBrBrepComplexTraverser&) = default;
  OdBrBrepComplexTraverser(OdBrBrepComplexTraverser&&) = default;
  OdBrBrepComplexTraverser& operator=(OdBrBrepComplexTraverser&&) = default;
  //DOM-IGNORE-END
#endif
