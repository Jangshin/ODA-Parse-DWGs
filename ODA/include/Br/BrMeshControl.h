...
protected:
  ...
  */
  ...
  //DOM-IGNORE-BEGIN
  OdBrMeshControl(const OdBrMeshControl&) = delete;
  OdBrMeshControl& operator=(const OdBrMeshControl&) = delete;
  OdBrMeshControl(OdBrMeshControl&&) = delete;
  OdBrMeshControl& operator=(OdBrMeshControl&&) = delete;
  //DOM-IGNORE-END
#endif
