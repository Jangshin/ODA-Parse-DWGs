...
protected:
  ...
  */
  ...
  //DOM-IGNORE-BEGIN
  OdBrMeshEntity(const OdBrMeshEntity&) = default;
  OdBrMeshEntity& operator=(const OdBrMeshEntity&) = default;
  OdBrMeshEntity(OdBrMeshEntity&&) = default;
  OdBrMeshEntity& operator=(OdBrMeshEntity&&) = default;
  //DOM-IGNORE-END
#endif
