...
public:
  ...
  //DOM-IGNORE-BEGIN
  OdBrBrepFaceTraverser(const OdBrBrepFaceTraverser&) = default;
  OdBrBrepFaceTraverser& operator=(const OdBrBrepFaceTraverser&) = default;
  OdBrBrepFaceTraverser(OdBrBrepFaceTraverser&&) = default;
  OdBrBrepFaceTraverser& operator=(OdBrBrepFaceTraverser&&) = default;
  //DOM-IGNORE-END
#endif
