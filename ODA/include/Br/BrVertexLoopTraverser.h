...
public:
  ...
  //DOM-IGNORE-BEGIN
  OdBrVertexLoopTraverser(const OdBrVertexLoopTraverser&) = default;
  OdBrVertexLoopTraverser& operator=(const OdBrVertexLoopTraverser&) = default;
  OdBrVertexLoopTraverser(OdBrVertexLoopTraverser&&) = default;
  OdBrVertexLoopTraverser& operator=(OdBrVertexLoopTraverser&&) = default;
  //DOM-IGNORE-END
#endif
