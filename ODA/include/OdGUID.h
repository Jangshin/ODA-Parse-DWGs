...
public:
  ...
  */
  ...
  /** \details
    ...
    OdGUID::StringFormat::Base64String: Encoded of the base 64 characters compressed string. 
                                        Contains 22 characters + 1 for the terminating 0
  */
  OdString toString(
...
private:
  ...
  __attribute__ ((aligned (4))) OdUInt8 m_data[0x10];
#else
  OdUInt8 m_data[0x10];
#endif
};
