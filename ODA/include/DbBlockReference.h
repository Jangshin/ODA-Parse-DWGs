...
public:
  struct Iterator : OdDbStepIteratorWrap<OdDbObjectIterator, OdDbAttributePtr>
  {
    Iterator(const OdDbObjectIteratorPtr& i) : OdDbStepIteratorWrap<OdDbObjectIterator, OdDbAttributePtr>(i) {}
    OdDbAttributePtr operator*() { return OdDbAttributePtr(m_pIterator->entity()); }
  };
  OdDbAttributeCollectionView(const OdDbObjectIteratorPtr& i) : m_pIterator(i) {}
...
public:
  ...
  */
  ...
  /** \details
    Returns a read-only view of the block reference attributes collection as a range of OdDbAttribute objects opened for read, that supports C++11 ranged-for loop.
  */
  OdDbAttributeCollectionView attributes() const { return OdDbAttributeCollectionView(attributeIterator()); }
  
  /** \details
    Returns a read-only view of the block reference attributes collection as a range of OdDbObjectId objects that supports C++11 ranged-for loop.
  */
  OdDbIdCollectionView attributeIds() const { return OdDbIdCollectionView(attributeIterator()); }
