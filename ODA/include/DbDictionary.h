...
public:
  ...
  */
  ...
  /** \details
    Returns a new iterator that can be used to traverse the entries in this Dictionary object.
  ...
  */
  ...
  /** \details
    Returns an iterator that points at the beginning of the dictionary.
    To be used to traverse through entries via "range-based for" loop. 
  ...
  */
  OdDbNextIteratorWrap<OdDbDictionaryIterator> begin() const {
    return OdDbNextIteratorWrap<OdDbDictionaryIterator>(newIterator());
  }

  /** \details
    Returns an iterator that points at the end of the dictionary,
    to support "range-based for" loop.
  */
  OdDbNextIteratorWrap<OdDbDictionaryIterator> end() const {
    return OdDbNextIteratorWrap<OdDbDictionaryIterator>(OdDbDictionaryIteratorPtr());
  }
