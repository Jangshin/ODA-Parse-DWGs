...
public:
  ...
  */
  ...
  /** \details
    ...
    \param atBeginning [in]  True - to iterate from the beginning to the end, or false - to iterate in reverse order.
    \param skipDeleted [in]  If true then skip erased records.
  */
...
class OdDbRecordIdCollectionView
{
  OdDbSymbolTableIteratorPtr m_pIterator;
public:
  struct Iterator : OdDbStepIteratorWrap<OdDbSymbolTableIterator, OdDbObjectId>
  {
    Iterator(const OdDbSymbolTableIteratorPtr& i) : OdDbStepIteratorWrap<OdDbSymbolTableIterator, OdDbObjectId>(i) {}
    OdDbObjectId operator*() const { return m_pIterator->getRecordId(); }
  };
  OdDbRecordIdCollectionView(const OdDbSymbolTableIteratorPtr& i) : m_pIterator(i) {}
  Iterator begin() const { return Iterator(m_pIterator); }
  Iterator end() const { return Iterator(OdDbSymbolTableIteratorPtr()); }
};
...
class OdDbRecordCollectionView
{
  OdDbSymbolTableIteratorPtr m_pIterator;
public:
  struct Iterator : OdDbStepIteratorWrap<OdDbSymbolTableIterator, OdDbSymbolTableRecordPtr>
  {
    Iterator(const OdDbSymbolTableIteratorPtr& i) : OdDbStepIteratorWrap<OdDbSymbolTableIterator, OdDbSymbolTableRecordPtr>(i) {}
    OdDbSymbolTableRecordPtr operator*() const { return m_pIterator->getRecord(); }
  };
  OdDbRecordCollectionView(const OdDbSymbolTableIteratorPtr& i) : m_pIterator(i) {}
  Iterator begin() const { return Iterator(m_pIterator); }
  Iterator end() const { return Iterator(OdDbSymbolTableIteratorPtr()); }
};

OdDbRecordIdCollectionView OdDbSymbolTable::ids(bool atBeginning, bool skipDeleted)
{
  return OdDbRecordIdCollectionView(newIterator(atBeginning, skipDeleted));
}

OdDbRecordCollectionView OdDbSymbolTable::records(bool atBeginning, bool skipDeleted)
{
  return OdDbRecordCollectionView(newIterator(atBeginning, skipDeleted));
}
//DOM-IGNORE-END
