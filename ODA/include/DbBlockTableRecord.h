...
{
  OdDbObjectIteratorPtr m_pIterator;
public:
  struct Iterator : OdDbStepIteratorWrap<OdDbObjectIterator, OdDbObjectId>
  {
    Iterator(const OdDbObjectIteratorPtr& i) : OdDbStepIteratorWrap<OdDbObjectIterator, OdDbObjectId>(i) {}
    OdDbObjectId operator*() { return m_pIterator->objectId(); }
    OdDbObjectId operator*() const { return m_pIterator->objectId(); }
  };
  OdDbIdCollectionView(const OdDbObjectIteratorPtr& i ) : m_pIterator(i) {}
  Iterator begin() const { return Iterator(m_pIterator); }
  Iterator end() const { return Iterator(OdDbObjectIteratorPtr()); }
};
...
class OdDbEntityCollectionView
{
  OdDbObjectIteratorPtr m_pIterator;
public:
  struct Iterator : OdDbStepIteratorWrap<OdDbObjectIterator, OdDbEntityPtr>
  {
    Iterator(const OdDbObjectIteratorPtr& i) : OdDbStepIteratorWrap<OdDbObjectIterator, OdDbEntityPtr>(i) {}
    OdDbEntityPtr operator*() { return m_pIterator->entity(); }
  };
  OdDbEntityCollectionView(const OdDbObjectIteratorPtr& i) : m_pIterator(i) {}
  Iterator begin() const { return Iterator(m_pIterator); }
  Iterator end() const { return Iterator(OdDbObjectIteratorPtr()); }
};
//DOM-IGNORE-END
...
public:
  ...
  */
  ...
  {
    return OdDbIdCollectionView(newIterator(atBeginning, skipDeleted, sorted));
  }
  ...
  */
  ...
  {
    return OdDbEntityCollectionView(newIterator(atBeginning, skipDeleted, sorted));
  }
