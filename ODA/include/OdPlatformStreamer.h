...
inline OdInt8 OdPlatformStreamer::rdInt8(OdStreamBuf& streamBuf)
{
  return static_cast<OdInt8>(streamBuf.getByte());
}
inline OdUInt8 OdPlatformStreamer::rdUInt8(OdStreamBuf& streamBuf)
{
  return streamBuf.getByte();
}
...
inline OdUInt32 OdPlatformStreamer::rdUInt32(OdStreamBuf& streamBuf)
{
  OdUInt32 res;
  streamBuf.getBytes(&res, sizeof(res));
  odSwap4BytesNumber(res);
...
inline OdUInt64 OdPlatformStreamer::rdUInt64(OdStreamBuf& streamBuf)
{
  OdUInt64 res;
  streamBuf.getBytes(&res, sizeof(res));
  odSwap8Bytes(&res);
...
inline void OdPlatformStreamer::wrInt8(OdStreamBuf& streamBuf, OdInt8 val)
{
  streamBuf.putByte(static_cast<OdUInt8>(val));
}
inline void OdPlatformStreamer::wrUInt8(OdStreamBuf& streamBuf, OdUInt8 val)
{
  streamBuf.putByte(val);
}
...
inline void OdPlatformStreamer::wrUInt32(OdStreamBuf& streamBuf, OdUInt32 val)
{
  odSwap4BytesNumber(val);
  streamBuf.putBytes(&val, sizeof(val));
}
...
inline void OdPlatformStreamer::wrUInt64(OdStreamBuf& streamBuf, OdUInt64 val)
{
  odSwap8Bytes(&val);
  streamBuf.putBytes(&val, sizeof(val));
}
...
inline OdString OdPlatformStreamer::getUnicodeStrFromBuffer(const OdUInt8*& buffer, OdInt32 size)
{
  ...
  {
    OdUInt8* pBuf = (OdUInt8*)ret.getBuffer(size);
    OD_BYTES_FROM_BUFFPTR(buffer, pBuf, (((size_t)size)<<1));
