...
public:
  ...
  */
  void getLeaderIndexes(
    OdIntArray& leaderIndexes) const;
  ...
  */
  void getLeaderLineIndexes(
    OdIntArray& leaderLineIndexes) const;
  ...
  */
  OdResult getOverridedMLeaderStyle(
    OdDbMLeaderStyle& mleaderStyle) const;
...
///** { Secret } */
bool DBENT_EXPORT OdDbMLeader_applyData(OdDbMLeader* pMLeader, const OdGePoint3dArray& points,
                                        OdDbObject* pObj = NULL, int ver = 0);

///** { Secret } */
void DBENT_EXPORT OdDbObject_clearDatabase(OdDbObject* pObj); // for tests only

///** { Secret } */
void DBENT_EXPORT OdDbObject_setWorkingDatabase(OdDbObject* pObj, OdDbDatabase* pWrkDb); // for tests only
