...
#ifndef SWIG
TOOLKIT_EXPORT_GLOBAL extern OdRxClass* g_odDbRegistredDwgClasses[kOdDbDwgClassMapSize_WithProxy];
#endif
...
public:                                                                                              \
  ...
  static OdRxClass* desc() { return g_odDbRegistredDwgClasses[kDwgId_##ClassName]; }                 \
                                                                                                     \
