...
public:
  ...
  */
  ...
  /** \details
    ...
    Otherwise, this surface is not changed and the result is stored in pNewSurface.
  ...
  */
  ...
  /** \details
    ...
    \returns eOk if the slicing operation is successfully performed or an appropriate error
    code otherwise. If solid is empty, returns eInvalidInput. If the specified plane does not
    intersect this surface, then this surface is left unchanged, pNegHalfSurface is set to NULL, eNoIntersections is returned.

    \remarks
    If this surface is OdDbSurface or OdDbPlaneSurface, positive part will be stored in this surface.
    Otherwise, positive part will be stored in pNewSurface and this surface will not be changed.
  */
  ...
  /** \details
    ...
    returns eInvalidInput. If the specified surface does not intersect this surface, then this surface and pNegHalfSurface are
    left unchanged, eNoIntersections is returned.
  ...
  */
  ...
  /** \details
    Creates an network surface.

    \param uProfiles   [in] U-direction profiles.
    \param vProfiles   [in] V-direction profiles.
    \param newSurface [out] Network surface to return.

    \returns eOk if the network surface was successfully created or an
    appropriate error code in the other case.

    \remarks
    Implemented for ModelerGeometry and Spatial Modeler, not supported in the C3D modeler.
  */
  static OdResult createNetworkSurface( const OdArray<OdDb3dProfilePtr>& uProfiles,
                                        const OdArray<OdDb3dProfilePtr>& vProfiles,
