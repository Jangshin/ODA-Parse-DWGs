...
public:
  ...
  */
  ...
  virtual OdGeVector3d getThicknessDirection() const;
  virtual void setThicknessDirection(const OdGeVector3d& vrDir, bool doSubents = false);
  ...
  */
  virtual OdDgHatchPatternPtr getHatchPattern(bool bMakeCopy = true) const;
...
public:
  ...
  virtual void setAnnotationScaleFlag(OdDgElement* pElm, bool bSet, double dAnnotationScale = 0, bool bRescaleGeometry = true, bool doSubents = true);

  virtual double getAnnotationScale(const OdDgElement* pElm);
  virtual void setAnnotationScale(OdDgElement* pElm, double dScale, bool bRescaleGeometry = true, bool doSubents = true);
};
