...
public:
  ...
  enum PrimaryIds
  {
    ...
    kXmlLinkage      = 0x56E3, // XML Linkage
    kSharedCellFlags = 0x56EA  // Shared cell annotation linkage
  };
...
/** \details
This template class is a specialization of the OdSmartPtr class for OdDgAssocRegionLinkage object pointers.

<group OdDg_Classes>
*/
class OdDgAssocRegionLinkage;
typedef OdSmartPtr<OdDgAssocRegionLinkage> OdDgAssocRegionLinkagePtr;
...
<group OdDg_Classes>
*/
class TG_EXPORT OdDgAssocRegionLinkage : public OdDgAttributeLinkage
{
public:
  ODRX_DECLARE_MEMBERS(OdDgAssocRegionLinkage);

  virtual void   readData(const OdUInt8* pData, OdUInt32 dataSize) = 0;

  virtual OdDgAssocRegion::OdDgAssocRegionType getRegionType() const = 0;
  virtual void setRegionType( const OdDgAssocRegion::OdDgAssocRegionType& uType ) = 0;

  virtual OdDgAssocRegion::OdDgAssocRegionFillModeInteriorShapes getFillModeInteriorShapes() const = 0;
  virtual void setFillModeInteriorShapes( const OdDgAssocRegion::OdDgAssocRegionFillModeInteriorShapes& uType ) = 0;

  virtual bool getLocateInteriorTextsFlag() const = 0;
  virtual void setLocateInteriorTextsFlag( bool bSet ) = 0;

  virtual double getFillModeMaxGap() const = 0;
  virtual void setFillModeMaxGap( double dGap ) = 0;
};
...
public:
  ...
  virtual OdDgTextExtendedProperties::OdDgSpecialSymbol getSymbol( OdUInt32 nEntry ) const = 0;
  virtual void     setSymbol( OdDgTextExtendedProperties::OdDgSpecialSymbol uValue, OdUInt32 nEntry ) = 0;
  virtual void     deleteSymbol( OdUInt32 nEntry ) = 0;
  virtual void     addSymbol( OdDgTextExtendedProperties::OdDgSpecialSymbol uValue ) = 0;
...
public:
  ...
  virtual OdGeVector3d getThicknessDirection() const = 0;
  virtual void         setThicknessDirection(const OdGeVector3d& vrDirection) = 0;
};
...
public:
  enum OdDgDoubleArrayLinkageArrayId
  {
    ...
    kPlacemarkTransform        = 0x07,
    kXRefLightingAndSaturation = 0x09,
    kXRefHSV                   = 0x0B,
    kAssocRgnTextMargin        = 0x0C,
...
public:
  ...
  virtual OdDgHatchPatternPtr getHatchPattern() const = 0;
  virtual void                setHatchPattern( const OdDgHatchPatternPtr& pPattern ) = 0;
};
...
{
public:
  enum OdDgByteArrayLinkageArrayId
  {
    kViewOrder = 0x5806
  };
...
public:
  ...
  virtual OdDgGradientKey getKey( OdUInt16 uKeyNumber ) = 0;
  virtual bool            setKeyColor( OdUInt16 uKeyNumber, ODCOLORREF clrKey ) = 0;
  virtual bool            addKey( const OdDgGradientKey& key ) = 0;
...
public:
  ...
  virtual bool getUseNoteTermFontId() const = 0;
  virtual bool getUseNoteTermSymbol() const = 0;
  virtual bool getUseAnnotationScaleValue() const = 0;
  ...
  virtual void setUseNoteTermFontId( bool bSetFlag ) = 0;
  virtual void setUseNoteTermSymbol( bool bSetFlag ) = 0;
  virtual void setUseAnnotationScaleValue( bool bSetFlag ) = 0;
  ...
  virtual OdDgDimNote::NoteTerminatorType getNoteTerminator() const = 0;
  virtual void setNoteTerminator( const OdDgDimNote::NoteTerminatorType iType ) = 0;
  ...
  virtual OdDgDimOptionTerminators::TerminatorStyle getNoteTerminatorStyle() const = 0;
  virtual void     setNoteTerminatorStyle( OdDgDimOptionTerminators::TerminatorStyle iStyle ) = 0;
  virtual OdUInt32 getNoteTermFontId() const = 0;
  virtual void     setNoteTermFontId( OdUInt32 uFontId ) = 0;
  virtual OdUInt16 getNoteTermSymbol() const = 0;
  virtual void     setNoteTermSymbol( OdUInt16 uSymbol ) = 0;
...
public:
  ...
  virtual OdUInt8     getStringStatus() const = 0;
  virtual void        setStringStatus(OdUInt8 uStatus) = 0;
...
public:
  ...
  virtual OdGiDgLinetypeModifiers getGiModifiers() const = 0;
  virtual void      setGiModifiers( const OdGiDgLinetypeModifiers& modifiers ) = 0;
};
...
public:
  ...
  virtual OdDg::OdDgInfiniteLineType getInfiniteLineType() const = 0;
  virtual void setInfiniteLineType( OdDg::OdDgInfiniteLineType type ) = 0;
};

/** \details
This template class is a specialization of the OdSmartPtr class for OdDgXmlLinkage object pointers.

Corresponding C++ library: TG_Db

<group OdDg_Classes>
*/
class OdDgXmlLinkage;
typedef OdSmartPtr<OdDgXmlLinkage> OdDgXmlLinkagePtr;
...
<group OdDg_Classes>
*/
class TG_EXPORT OdDgXmlLinkage : public OdDgAttributeLinkage
{
public:
  ODRX_DECLARE_MEMBERS(OdDgXmlLinkage);

  virtual void   readData(const OdUInt8* pData, OdUInt32 dataSize) = 0;

  virtual OdString getName() const = 0;
  virtual void setName( const OdString& strName) = 0;
  virtual OdString getXmlData() const = 0;
  virtual void setXmlData( const OdString& strXml) = 0;
};
...
/** \details
This template class is a specialization of the OdSmartPtr class for OdDgSharedCellFlagsLinkage object pointers.
*/
class OdDgSharedCellFlagsLinkage;
typedef OdSmartPtr<OdDgSharedCellFlagsLinkage> OdDgSharedCellFlagsLinkagePtr;
...
<group OdDg_Classes>
*/
class TG_EXPORT OdDgSharedCellFlagsLinkage : public OdDgAttributeLinkage
{
public:
  ODRX_DECLARE_MEMBERS(OdDgSharedCellFlagsLinkage);
