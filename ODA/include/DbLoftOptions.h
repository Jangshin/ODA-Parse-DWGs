...
public:
  ...
  */
  ...
  /** \details
  Returns the value of the periodic flag.
  ...
  */
  ...
  /** \details
  Sets the value of the periodic flag.

  If value us true - ruled flag sets to false.

  \param periodic [in]  A new value of the periodic flag.
*/
  ...
  */
  ...
  /** \details
    ...
    The default value is false. If coming value is false - flag periodic also sets to false.
