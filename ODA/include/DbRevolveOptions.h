...
public:
  ...
  */
  ...
  /** \details
    Compares two OdDbRevolveOptions objects, returns true when their values are equal,
    or false when their values are not equal.

    \param opt [in] Another OdDbRevolveOptions object to compare.
  */
  bool operator ==(const OdDbRevolveOptions& opt) const;
