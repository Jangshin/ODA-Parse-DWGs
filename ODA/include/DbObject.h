...
public:
  ...
  */
  ...
  /** \details
    Checks if there is some extended data for the given application name.
    If the name is empty then the function returns true if there is any xdata attached to the object.
    \param regappName [in]  Registered application for which to return XData.
  */
...
//  bool isCancelling() const;
  ...
  */
  ...
  /** \details
    Performs cloning of this object between databases (e.g. in OdDbDatabase::wblockCloneObjects, insert, bind etc.).
