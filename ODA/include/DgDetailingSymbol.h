...
public:
  ...
  virtual void     setAnnotationScaleFlag( bool bOn, double dAnnotationScale = 0, bool bRescaleGeometry = true ) = 0;

  virtual double   getAnnotationScale() const = 0;
  virtual void     setAnnotationScale( double dAnnotationScale, bool bRescaleGeometry = true ) = 0;
};
...
public:
  ...
  virtual void     setAnnotationScaleFlag(bool bOn, double dAnnotationScale = 0, bool bRescaleGeometry = true);

  virtual double   getAnnotationScale() const;
  virtual void     setAnnotationScale(double dAnnotationScale, bool bRescaleGeometry = true);
