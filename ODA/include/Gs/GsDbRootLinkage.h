...
class GS_TOOLKIT_EXPORT OdGsDbRootLinkage
{
  public:
    ...
    */
    static OdRxClass* getDbBaseLinetypePEClass();
    /** \details
        Returns OdDbBaseLinetypetPE protocol extension linked with Linetype object.
        \param pLinetype [in]  Linetype object pointer.
    */
    static OdDbBaseLinetypePE* getDbBaseLinetypePE(const OdRxObject* pLinetype);
};
