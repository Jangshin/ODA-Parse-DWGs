...
public:
  ...
  public:
    ...
    */
    ...
    /** \details
      Plays a metafile for the specified entity node.
...
public:
  ...
  */
  ...
  public:
    /** \details
      Destructor for the MetafilePtrArray class.
    */
    ~MetafilePtrArray(){}
  };
...
public:
  ...
  */
  ...
  /** \details
    Returns metafile pointer compatible with requested view configuration.
  ...
  */
  ...
  /** \details
    Finds first Gs metafile for requested view.
    \param view [in]  View object for which metafile is to be returned.
    \param bContainsNested [out]  Optionally returns true if metafile contains nested metafile entries.
    \param findCompatibleLevel [in]  Check for viewport changes if and only if true.
  */
...
public:
  ...
  */
  ...
  /** \details
    Sets a branch of subentities and nested entities to highlight, hide or transform.
    \param pBr [in] Pointer to a branch of subentities and nested entities.
  */
  void setStateBranch(OdGsStateBranch *pBr);
  /** \details
    Resets state branch of specified type.
    \param branchType [in] Type of state branch to reset.
  */
  void resetStateBranch(OdGsStateBranch::BranchType branchType = OdGsStateBranch::kHighlightingBranch);
  /** \details
    Retrieves a branch of subentities and nested entities to highlight, hide or transform.
    \param branchType [in] Type of state branch to retrieve.
  */
  ...
  */
  ...
  /** \details
    Returns true in case if any type of state branch available.
  */
  bool hasAnyStateBranch() const;

  /** details
    Plays geometry metafile for specified vectorization view depending on playing mode.
    \param view [in] Vectorization view.
    \param eMode [in] Playing mode.
  */
  ...
  */
  ...
  /** \details
    Returns flag state which indicated that extents of this node is too large to store it in spatial index tree.
    \returns
    true if extents of this node is too large to store it in spatial index tree or false elsewhere.
  */
  bool isExtentsOutOfModelSpace() const;
  /** \details
    Sets flag which indicates that extents of this node is too large to store them in spatial index tree.
    \param flag [in] Flag state to set.
  */
...
public:
  ...
  */
  ...
  /** \details
    Transforms the specified extents according to the specified state branch.

    \param ext           [in/out]  Extents to modify.
    \param pTransformBr  [in]  Pointer to the specified state branch.
    \param bInverse      [in]  Execute transform if false and untransform if true.
  */
