...
public:
  ...
  */
  ...
  /** \details
    Retrieves pointer to background traits of an environment background.
  */
  OdGiEnvironmentBackgroundTraitsData* environmentBackgroundTraitsData() const { return (OdGiEnvironmentBackgroundTraitsData*)m_pBackgroundTraits; }

  /** \details
    Retrieves pointer to background traits of an custom background.
  */
  OdGiCustomBackgroundTraitsData* customBackgroundTraitsData() const { return (OdGiCustomBackgroundTraitsData*)m_pBackgroundTraits; }
