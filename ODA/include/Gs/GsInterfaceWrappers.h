...
class OdGsViewWrapper : public RedirectionBase
{
  ...
  public:
    ...
    */
    ...
    {
      if (trHas())
        trCall()->setLineweightEnum(numLineweights, lineweights, altSourceLwds);
    }
   ...
   */
    ...
    */
    void rayTrace(const OdGePoint3d &rayOrigin, const OdGeVector3d &rayDirection,
                  OdGsRayTraceReactor *pReactor, bool bSortedSelection = false,
                  OdGiPathNode const* const* pObjectList = NULL, OdUInt32 nObjectListSize = 0)
    {
      if (trHas())
        trCall()->rayTrace(rayOrigin, rayDirection, pReactor, bSortedSelection, pObjectList, nObjectListSize);
    }
