...
protected:
  ...
  */
  ...
  /** \details
    ...
    \param pView [in]  Pointer to the OdGsView object.
    \param flags [in]  Bit flags of ViewUpdateFlags type representing view properties that are affected.
  */
  ...
  */
  ...
  /** \details
    Default constructor for the OdGsBaseModule class.
  */
  OdGsBaseModule();
...
public:
  ...
  /** \details
    This class is used for view update events.
  */
  ...
  public:
    /** \details
      Constructor for the GsViewUpdateEvent class.
      
      \param pView [in]  Pointer to a module.
      \param pView [in]  Pointer to a graphics view.
      \param flags [in]  Bit flags of ViewUpdateFlags type representing view properties that are affected.
    */
