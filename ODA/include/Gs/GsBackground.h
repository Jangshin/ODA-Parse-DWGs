...
/** \details
  This class defines the interface for OdGsBackground objects creation.

  Corresponding C++ library: TD_Gs

  <group Other_Classes>
*/
class ODRX_ABSTRACT GS_TOOLKIT_EXPORT OdGsBackgroundModule : public OdRxModule
{
  public:
    ODRX_DECLARE_MEMBERS(OdGsBackgroundModule);

    /** \details
      Creates OdGsBackground object for type.
      \param type [in]  Type of background.
      \returns OdGsBackground object.
    */
    virtual OdGsBackgroundPtr createBackground(OdGsBackground::BackgroundType type) = 0;
};
