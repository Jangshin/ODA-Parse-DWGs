...
struct OdGsOverlayMapping
{
  protected:
    ...
    inline static OdInt32 numOverlays1() { return OdInt32(kNumOverlays); }
    inline static OdInt32 numOverlays2() { return OdInt32(kNumGsOverlays); }
  ...
  public:
    ...
    */
    ...
    {
      static const bool bSameEnums = (numOverlays1() == numOverlays2()); // #VIS-2490
...
/** \details
  This class is a placeholder for overlay data.
