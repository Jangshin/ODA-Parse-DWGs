...
public:
  ...
  */
  ...
  enum
  {
    kNotImplemented = 0x80000000, // Extended selection callback method is not implemented.
    kContinue       = 0,          // Continue selection process.
    kBreak          = 1,          // Break selection process.
    kSkipDrawable   = 2           // Skip current drawable selection process.
  };
  //DOM-IGNORE-END
  ...
  /** \details
    ...
    \param pathNode [in]  Path to selected object.
    \param viewInfo [in]  Viewport in which selection was executed.
