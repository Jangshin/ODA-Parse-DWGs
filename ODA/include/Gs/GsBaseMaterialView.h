...
struct GS_TOOLKIT_EXPORT OdGsLightsAccumulationContainter
{
  ...
  /** \details
    Default constructor for the OdGsLightsAccumulationContainter class.
  */
  OdGsLightsAccumulationContainter() {}
  
  /** \details
    Destructor for the OdGsLightsAccumulationContainter class.
  */
...
class GS_TOOLKIT_EXPORT OdGsBaseMaterialView : public OdGsBaseVectorizeViewJoin<OdGsBaseMaterialViewPC>
{
  public:
    /** \details
      Constructor for the OdGsBaseMaterialView class. Creates an object with the specified flags.
      
      \param uMaterialViewFlags [in]  Material flags for a view.
    */
