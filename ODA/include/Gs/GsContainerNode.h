...
public:
  ...
  */
  inline void setRealExtents(OdUInt32 nVpId, const OdGsUpdateExtents& ext, bool bRecompute = false);
...
inline void OdGsContainerNode::setRealExtents(OdUInt32 nVpId, const OdGsUpdateExtents& ext, bool bRecompute)
{
  VpData *pVpData = getVpData(nVpId);
  pVpData->m_realExtents = ext;
  SETBIT(pVpData->m_flags, VpData::kRecomputeExtents, bRecompute);
}
