...
public:
  ...
  */
  virtual void highlight(const OdGiPathNode& path, const OdGsMarker* pMarkers, OdUInt32 nMarkers, bool bDoIt = true,
                         OdUInt32 nStyle = 0, const OdGsView* pView = NULL) = 0;
  ...
  */
  virtual void hide(const OdGiPathNode& path, const OdGsMarker* pMarkers, OdUInt32 nMarkers, bool bDoIt = true,
                    bool bSelectHidden = false, const OdGsView* pView = NULL) = 0;
  ...
  */
  virtual void externalTransform(const OdGiPathNode& path, const OdGsMarker* pMarkers, OdUInt32 nMarkers, bool bDoIt = true,
                                 const OdGsMatrixParam *xForm = NULL, const OdGsView* pView = NULL) = 0;
...
class OdGsModelReactor
{
  public:
    /** \details
      Default constructor for the OdGsModelReactor class.
    */
    OdGsModelReactor() { }
    
    /** \details
      Destructor for the OdGsModelReactor class.
    */
