...
public:
  ...
  void setGiMaterialMap( const OdGiMaterialMap& matMap, bool bUpdateMappingType = false );
  ...
  bool operator== (const OdDgMaterialMap &other) const;
  bool operator!= (const OdDgMaterialMap &other) const;
...
public:
  ...
  void             addUserData(const OdString& strData );
  bool             removeUserData( OdUInt32 uIndex );
  OdString         getUserData( OdUInt32 uIndex ) const;
  bool             setUserData( OdUInt32 uIndex, const OdString& strData );
...
public:
 ...
 virtual bool     prepareTextureMapper( OdDgModelPtr pObjectModel, OdGePoint3d ptOrigin, 
                                        ...
                                        OdGeVector3d vrYAxis ,OdGeVector3d vrZAxis, 
                                        OdGiMapper& texMapper, double dTransformationScale = 1.0 ) const;
