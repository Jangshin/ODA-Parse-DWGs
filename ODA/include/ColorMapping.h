...
/** \details
	Builds a palette depending on a given background.
	\param background [in] Color of the background.

	\returns The palette for the given background.
*/
FIRSTDLL_EXPORT const ODCOLORREF * odcmAcadDynamicPalette(ODCOLORREF background);
