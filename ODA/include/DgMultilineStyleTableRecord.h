...
public:
  ...
  void setLineStyleScale( double dScale);

  double getLineStyleWidth() const;
  void setLineStyleWidth( double dWidth );

  bool getUseLineStyleScaleFlag() const;
  void setUseLineStyleScaleFlag( bool bSet );

  bool getUseLineStyleWidthFlag() const;
  void setUseLineStyleWidthFlag( bool bSet );
...
private:
  ...
  double   m_dLineStyleWidth;
  bool     m_bUseLineStyleScale;
  bool     m_bUseLineStyleWidth;
};
