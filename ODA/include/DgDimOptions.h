...
public:
  ...
  virtual TerminatorStyle getNoteTermStyle() const = 0;
  ...
  virtual void            setNoteTermStyle( TerminatorStyle iStyle ) = 0;
  ...
  virtual OdUInt32        getNoteFontID() const = 0;
  virtual OdChar          getNoteSymbol() const = 0;
  virtual OdUInt64        getNoteCellID() const = 0;
  virtual void            setNoteFontID( OdUInt32 uiFont ) = 0;
  virtual void            setNoteSymbol( OdChar chSymbol ) = 0;
  virtual void            setNoteCellID( OdUInt64 iId ) = 0;
};
...
<group OdDg_Classes>
*/
class TG_EXPORT OdDgDimOptionPrefixSuffixSymbol : public OdDgDimOptionSymbol
{
public:

  enum OdDgDimPrefixSuffixStyle
  {
    kNone       = 0,
    kSymbol     = 1,
    kScaledCell = 2
...
public:
  ODRX_DECLARE_MEMBERS( OdDgDimOptionPrefixSuffixSymbol );

  virtual OdDgDimPrefixSuffixStyle getStyle() const = 0;
  virtual void                     setStyle( OdDgDimPrefixSuffixStyle uStyle ) = 0;

  virtual OdUInt64    getCellId()  const = 0;
  virtual void        setCellId( OdUInt64 uCellId ) = 0;

  virtual double      getCellScale() const = 0;
  virtual void        setCellScale( double dScale ) = 0;
};

typedef OdSmartPtr<OdDgDimOptionPrefixSuffixSymbol> OdDgDimOptionPrefixSuffixSymbolPtr;
...
<group OdDg_Classes>
*/
class TG_EXPORT OdDgDimOptionPrefixSymbol : public OdDgDimOptionPrefixSuffixSymbol
{
public:
...
<group OdDg_Classes>
*/
class TG_EXPORT OdDgDimOptionSuffixSymbol : public OdDgDimOptionPrefixSuffixSymbol
{
public:
...
public:
  ...
  virtual OdUInt64     getProxyCellId() const = 0;
  virtual void         setProxyCellId( OdUInt64 uId ) = 0;

  static OdUInt16      calculateCheckSum( OdDgDimension* pDim );
  static bool          setDrawDimensionAsCell( OdDgDimension* pDim, const OdDgElementId& idCell, 
