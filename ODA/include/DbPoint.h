  ...
  */
  ...
  /** \details
    ...
    <link db_point_specific, Specific Point Properties>
		\sa
    <link OdDbPoint::setPosition@OdGePoint3d&, OdDbPoint::setPosition() method>
  */
  ...
  /** \details
    ...
    <link db_point_specific, Specific Point Properties>
		\sa
    <link OdDbPoint::position@const OdDbPoint::position() method>
  */
  ...
  /** \details
    ...
    <link db_point_specific, Specific Point Properties>
		\sa
    <link OdDbPoint::setThickness@double, OdDbPoint::setThickness() method>
  */
  ...
  /** \details
    ...
    <link db_point_specific, Specific Point Properties>
		\sa
    <link OdDbPoint::thickness@const, OdDbPoint::thickness() method>
  */
  ...
  /** \details
    ...
    <link db_point_specific, Specific Point Properties>
		\sa
    <link OdDbPoint::setNormal@OdGeVector3d&, OdDbPoint::setNormal() method>
  */
  ...
  /** \details
    ...
    <link db_point_specific, Specific Point Properties>
    \sa
		<link OdDbPoint::normal@const, OdDbPoint::normal() method>
  */
  ...
  /** \details
    ...
    <link db_point_specific, Specific Point Properties>
		\sa
    <link OdDbPoint::setEcsRotation@double, OdDbPoint::setEcsRotation() method>
  */
  ...
  /** \details
    ...
    <link db_point_specific, Specific Point Properties>
		\sa
    <link OdDbPoint::ecsRotation@const, OdDbPoint::ecsRotation() method>
  */
  ...
  /** \details
    ...
    <link db_point, Working with Points>
		\sa
    <link OdDbPoint::getPlane@OdGePlane&@OdDb::Planarity&@const, OdDbPoint::getPlane()>, <link OdDbEntity::isPlanar@const, OdDbEntity::isPlanar()> methods
  */
  ...
  /** \details
    ...
    <link db_point, Working with Points>
		\sa
    <link OdDbPoint::isPlanar@const, OdDbPoint::isPlanar()>, <link OdDbEntity::getPlane@OdGePlane&@OdDb::Planarity&@const, OdDbEntity::getPlane()> methods
  */
