...
public:
  ...
  */
  virtual OdDbObjectId viewLabelTextStyleId() const = 0;
  /** \details
    Returns the view label's color.
  */
  virtual OdCmColor viewLabelTextColor() const = 0;
  /** \details
    Returns the view label's text height.
  */
  virtual double viewLabelTextHeight() const = 0;
  /** \details
    Returns the view label's offset.
  */
  virtual double viewLabelOffset() const = 0;
  /** \details
    Returns the view label's attachment.
  */
  virtual AttachmentPoint viewLabelAttachment() const = 0;
  /** \details
    Returns the view label's text alignment.
  */
  virtual TextAlignment viewLabelAlignment() const = 0;
  /** \details
    Returns the view label's pattern.
  */
  virtual OdString viewLabelPattern() const = 0;
protected:
