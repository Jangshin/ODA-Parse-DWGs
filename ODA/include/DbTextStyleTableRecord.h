...
TOOLKIT_EXPORT OdGiTextStyle giTextStyleFromDb(const OdDbTextStyleTableRecord* pTStyle);
TOOLKIT_EXPORT OdGiTextStyle giTextStyleFromDb(const OdDbObjectId& styleId);
