...
public:
  ...
  /** \details
    Returns true if and only if the block used to construct this OdDbDynBlockTableRecord contains dynamic block information.
  */
  bool isDynamicBlock() const;
  
  /** \details
    Returns true if and only if the given block contains dynamic block information.

    \param pBlockTableRecord [in]  A block table record to check.
  */
  static bool isDynamicBlock(const OdDbBlockTableRecord* pBlockTableRecord);
  
  /** \details
    Returns the id of the block used to construct this object.
  */
  ...
  */
  ...
  /** \details
    Updates the representation blocks for this dynamic block.
  */
