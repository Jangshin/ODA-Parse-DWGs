...
///////////////////////////////////////////////////////////////////////////////
#ifndef _ODSPATIALREFERENCE_ODSPATIALREFERENCE_INCLUDED_
#define _ODSPATIALREFERENCE_ODSPATIALREFERENCE_INCLUDED_
...
namespace OdSpatialReference
{
  ...
  */
  ...
  {
    kProjectionParameterNotUsed = 0,        // Not used.
    kProjectionParameterCntmer = 1,         // Central Meridian.
    kProjectionParameterNstdpll = 2,        // Northern Standard Parallel.
    kProjectionParameterSstdpll = 3,        // Southern Standard Parallel.
    kProjectionParameterStdpll = 4,         // Standard Parallel.
    kProjectionParameterGcp1lng = 5,        // First Great Circle Point Longitude.
    kProjectionParameterGcp1lat = 6,        // First Great Circle Point Latitude.
    kProjectionParameterGcp2lng = 7,        // Second Great Circle Point Longitude.
    kProjectionParameterGcp2lat = 8,        // Second Great Circle Point Latitude.
    kProjectionParameterGcplng = 9,         // Great Circle Point Longitude.
    kProjectionParameterGcplat = 10,        // Great Circle Point Latitude.
    kProjectionParameterGcazm = 11,         // Great Circle Azimuth.
    kProjectionParameterYaxisaz = 12,       // Y axis azimuth.
    kProjectionParameterEstdmer = 13,       // Eastern Standard Meridian.
    kProjectionParameterNparall = 14,       // Northern Parallel.
    kProjectionParameterSparall = 15,       // Southern Parallel.
    kProjectionParameterP1lng = 16,         // First pole longitude.
    kProjectionParameterP1lat = 17,         // First pole latitude.
    kProjectionParameterP2lng = 18,         // Second pole longitude.
    kProjectionParameterP2lat = 19,         // Second pole latitude.
    kProjectionParameterAdp1p2 = 20,        // Distance between the poles.
    kProjectionParameterAdsp1 = 21,         // Angular distance to the first standard parallel.
    kProjectionParameterAdsp2 = 22,         // Angular distance to the second standard parallel.
    kProjectionParameterCmplxan = 23,       // Complex Parameter A (n). Label string includes a %s for generation by sprintf.
    kProjectionParameterCmplxbn = 24,       // Complex Parameter B (n). Label string includes a %s for generation by sprintf.
    kProjectionParameterWestll = 25,        // Western end of Longitude range.
    kProjectionParameterEastll = 26,        // Eastern end of Longitude range.
    kProjectionParameterUtmzn = 27,         // UTM Zone Number.
    kProjectionParameterHsns = 28,          // North/South Hemisphere.
    kProjectionParameterGhgt = 29,          // Average Geoid Height.
    kProjectionParameterAelev = 30,         // Average Elevation.
    kProjectionParameterPolelng = 31,       // Oblique Pole Longitude.
    kProjectionParameterPolelat = 32,       // Oblique Pole Latitude.
    kProjectionParameterOstdpll = 33,       // Oblique Cone Standard Parallel.
    kProjectionParameterStdcir = 34,        // Standard Circle Latitude.
    kProjectionParameterAfa0 = 35,          // Affine A0 Coefficient.
    kProjectionParameterAfb0 = 36,          // Affine B0 Coefficient.
    kProjectionParameterAfa1 = 37,          // Affine A1 Coefficient.
    kProjectionParameterAfa2 = 38,          // Affine A2 Coefficient.
    kProjectionParameterAfb1 = 39,          // Affine B1 Coefficient.
    kProjectionParameterAfb2 = 40,          // Affine B2 Coefficient.
    kProjectionParameterNrmlpll = 41,       // Normal Parallel.
    kProjectionParameterDenrgn = 42,        // Danish System 24 Region.
    kProjectionParameterSkwazm = 43,        // cs_PRMCOD_SKWAZM - Skew Azimuth at Rectified Origin.
    kProjectionParameterSclrotorgx = 44,    // X Coordinate of Scale/Rotate Origin.
    kProjectionParameterSclrotorgy = 45,    // Y Coordinate of Scale/Rotate Origin.
    kProjectionParameterNrthscl = 46,       // Cartesian Scale Factor.
    kProjectionParameterNrthrot = 47,       // Cartesian Rotation Angle.
    kProjectionParameterEllipsoidScale = 48 // Ellipsoid scaling factor.
  };
  ...
  */
  enum ProjectionCode
  {
    ...
    kProjectionCodePlateCarree = 68,    // Plate Carre projection.
  ...
  {
    kDatumCalcTechNone               = 0,
    kDatumCalcTechMolodensky         = 1,
    kDatumCalcTechMultipleRegression = 2,
    kDatumCalcTechBursaWolf          = 3,
    kDatumCalcTechNAD27              = 4,
    kDatumCalcTechNAD83              = 5,
    kDatumCalcTechWGS84              = 6,
    kDatumCalcTechWGS72              = 7,
    kDatumCalcTechHARN               = 8,
    kDatumCalcTech7Params            = 9,
    kDatumCalcTechAGD66              = 10,
    kDatumCalcTech3Params            = 11,
    kDatumCalcTech6Params            = 12,
    kDatumCalcTech4Params            = 13,
    kDatumCalcTechAGD84              = 14,
    kDatumCalcTechNZGD4              = 15,
    kDatumCalcTechATS77              = 16,
    kDatumCalcTechGDA94              = 17,
    kDatumCalcTechNZGD2k             = 18,
    kDatumCalcTechCSRS               = 19,
    kDatumCalcTechTOKYO              = 20,
    kDatumCalcTechRGF93              = 21,
    kDatumCalcTechED50               = 22,
    kDatumCalcTechDHDN               = 23,
    kDatumCalcTechETRF89             = 24,
    kDatumCalcTechGeocentric         = 25,
    kDatumCalcTechCHENxy             = 26,
    kDatumCalcTechPLYNM              = 27
  };
}

#endif //_ODSPATIALREFERENCE_ODSPATIALREFERENCE_INCLUDED_
