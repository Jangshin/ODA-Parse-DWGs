...
/**
  ...
  \remarks Currently supported only in SpaModeler.
...
VAR_DEF(  double,                    LATITUDE,            (37.7950),               (37.7950),                             (),                         ValidateDouble(-90., 90.))
...
VAR_DEF(  double,                    LONGITUDE,           (-122.3940),             (-122.3940),                             (),                         ValidateDouble(-180., 180.))
...
/**
  <title EXPORTMODELSPACE>
  <toctitle EXPORTMODELSPACE>
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbDatabase::getEXPORTMODELSPACE()
   OdDbDatabase::setEXPORTMODELSPACE()
  </table>    
...
*/
/**
  <title EXPORTPAPERSPACE>
  <toctitle EXPORTPAPERSPACE>
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbDatabase::getEXPORTPAPERSPACE()
   OdDbDatabase::setEXPORTPAPERSPACE()
  </table>    
...
/**
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbDatabase::getEXPORTPAGESETUP()
   OdDbDatabase::setEXPORTPAGESETUP()
  </table>    
...
/**
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbDatabase::getFRAME()
   OdDbDatabase::setFRAME()
  </table>    
...
/**
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbDatabase::getPDFFRAME()
   OdDbDatabase::setPDFFRAME()
  </table>    
...
/**
  ...
  <table>
   <b>Value</b>   <b>Description</b>
   0              Creates legacy polygons or polyface meshes when you use REVSURF, TABSURF, RULESURF, or EDGESURF
   1              Creates full-featured mesh objects when you use REVSURF, TABSURF, RULESURF, or EDGESURF (recommended)
  </table>
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbDatabase::getMESHTYPE()
   OdDbDatabase::setMESHTYPE()
  </table>    
...
/**
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbDatabase::getSKYSTATUS()
   OdDbDatabase::setSKYSTATUS()
  </table>    
...
/**
  <title GEOMARKPOSITIONSIZE>
  <toctitle GEOMARKPOSITIONSIZE>
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbDatabase::getGEOMARKPOSITIONSIZE()
   OdDbDatabase::setGEOMARKPOSITIONSIZE()
  </table>
...
/**
  <title POINTCLOUDPOINTSIZE>
  <toctitle POINTCLOUDPOINTSIZE>
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbDatabase::getPOINTCLOUDPOINTSIZE()
   OdDbDatabase::setPOINTCLOUDPOINTSIZE()
  </table>
...
//-----------------------------------------
// Variables added in AC 2022 
//-----------------------------------------

/**
  <title TRACECURRENT>
  <toctitle TRACECURRENT>
  ...
  <table>
   ...
   OdDbDatabase::getSysVar()
   &nbsp;
   OdDbDatabase::getTRACECURRENT()
  </table>

<group TD_SysVars_T>
  */
  //<dom_var_def>OdString TRACECURRENT;
  RO_VAR_DEF(OdString, TRACECURRENT, (OD_T("")), (OD_T("")), (), ValidateNone())
  ...
  <table>
   <b>Value</b>       <b>Description</b>
       0              Trace mode is turn off
       1              Trace open to view
       2              Trace open to edit
  </table>
  ...
  <table>
   ...
   OdDbDatabase::getSysVar()
   &nbsp;
   OdDbDatabase::getTRACEMODE()
  </table>

<group TD_SysVars_T>
  */
  //<dom_var_def>OdUInt8 TRACEMODE;
  RO_VAR_DEF(OdUInt8, TRACEMODE, (0), (0), (), ValidateRange(0, 2))

  /**
  <title TRACEDISPLAYMODE>
  <toctitle TRACEDISPLAYMODE>
  ...
  <table>
   <b>Value</b>       <b>Description</b>
       0              Trace mode is turn off
       1              Tracing paper not displayed
       2              Tracing paper displayed
  </table>
  ...
  <table>
   ...
   OdDbDatabase::getSysVar()
   &nbsp;
   OdDbDatabase::getTRACEDISPLAYMODE()
  </table>

<group TD_SysVars_T>
  */
  //<dom_var_def>OdUInt8 TRACEDISPLAYMODE;
  RO_VAR_DEF(OdUInt8, TRACEDISPLAYMODE, (0), (0), (), ValidateRange(0, 2))
...
/**
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbHostAppServices::getAPERTURE()
   OdDbHostAppServices::setAPERTURE()
  </table>   
...
/**
  <title PLINEREVERSEWIDTHS>
  <toctitle PLINEREVERSEWIDTHS>
  ...
  PLINEREVERSEWIDTHS controls whether widths of a polyline must be reversed
  when reversing the polyline (e.g. calling reverseCurve method).

  <table>
   <b>Value</b>   <b>Description</b>
   false          Widths will not be reversed
   true           Widths will be reversed
  </table>
...
<group TD_SysVars_P>
  */
//<dom_var_def>bool PLINEREVERSEWIDTHS;
REGVAR_DEF(bool, PLINEREVERSEWIDTHS, (0), (), ValidateBOOL())
...
/**
  <title SMOOTHMESHCONVERT>
  <toctitle SMOOTHMESHCONVERT>
  ...
  SMOOTHMESHCONVERT - controls mesh objects mode conversion to 3D solids or surfaces are smoothed or faceted,
  and whether their faces are merged.
  0 (default) - creates a smooth model. Coplanar faces are optimized and merged in one face.
  1 - creates a smooth model. Original mesh faces are retained in the converted object.
  2 - creates a model with flattened faces. Coplanar faces are optimized and merged.
  3 - creates a model with flattened faces. Original mesh faces are retained in the converted object.

  <table>
   <b>Value</b>   <b>Description</b>
   0              Smoothed and optimized
   1              Smoothed and not optimized
   2              Faceted and optimized
   3              Faceted and not optimized
  </table>
  ...
  <group TD_SysVars_S>
  */
  //<dom_var_def>OdInt8 SMOOTHMESHCONVERT;
  REGVAR_DEF(OdInt16, SMOOTHMESHCONVERT, (0), (), ValidateRange(0, 3))
...
/**
  <title GRIPCONTOUR>
  <toctitle GRIPCONTOUR>

  <table>
   <b>Type</b>            OdInt16
   <b>Initial value</b>   251
   <b>Read-Only</b>       No
   <b>Saved In</b>        Registry
   <b>Versions</b>        2011+
  </table>
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp; 
   OdDbHostAppServices::getGRIPCONTOUR()
   OdDbHostAppServices::setGRIPCONTOUR()
  </table>  

<group TD_SysVars_G>
  */
//<dom_var_def>OdInt16 GRIPCONTOUR;
...
/**
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp; 
   OdDbHostAppServices::getSAVEFIDELITY()
   OdDbHostAppServices::setSAVEFIDELITY()
  </table>  
...
/**
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp; 
   OdDbHostAppServices::getDWFOSNAP()
   OdDbHostAppServices::setDWFOSNAP()
  </table>  
...
/**
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp; 
   OdDbHostAppServices::getDGNOSNAP()
   OdDbHostAppServices::setDGNOSNAP()
  </table>  
...
/**
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp; 
   OdDbHostAppServices::getPDFOSNAP()
   OdDbHostAppServices::setPDFOSNAP()
  </table> 
...
/**
  ...
  HPGAPTOL - specifies the size of possible gaps between entities when creating a loop for a OdDbHatch by a pick point command.
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbHostAppServices::getHPGAPTOL()
   OdDbHostAppServices::setHPGAPTOL()
   </table>

   <group TD_SysVars_H>
   */
   //<dom_var_def>OdInt16 HPGAPTOL;
  REGVAR_DEF(double, HPGAPTOL, (0), (), ValidateRange(0, 5000))

/**
  <title POINTCLOUDPOINTMAXLEGACY>
  <toctitle POINTCLOUDPOINTMAXLEGACY>
  ...
  POINTCLOUDPOINTMAXLEGACY controls the maximum number of points that can be displayed for all point
  clouds attached to the drawing and represented by OdDbPointCloud entities.
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbHostAppServices::getPOINTCLOUDPOINTMAXLEGACY()
   OdDbHostAppServices::setPOINTCLOUDPOINTMAXLEGACY()
  </table>

<group TD_SysVars_P>
  */
  //<dom_var_def>OdInt32 POINTCLOUDPOINTMAXLEGACY;
REGVAR_DEF(OdInt32,        POINTCLOUDPOINTMAXLEGACY,      (1500000),            (),             ValidateRange(1500000,10000000))

/**
  <title POINTCLOUDLOD>
  <toctitle POINTCLOUDLOD>
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbHostAppServices::getPOINTCLOUDLOD()
   OdDbHostAppServices::setPOINTCLOUDLOD()
  </table>

<group TD_SysVars_P>
  */
  //<dom_var_def>OdInt16 POINTCLOUDLOD;
...
HPSMOOTHEVALUATE controls whether a hatch is smoothed when a rendering device does not provide non-zero deviation. The default value is 0. Value 0 means is turn off.
HPSMOOTHEVALUATE controls the number of segments elliptical arcs, or circle arcs on intervals 0..Oda2PI.
Only the database-resident hatch entity can use HPSMOOTHEVALUATE variable. If the rendering device provides non-zero deviation values, 
...
E.g.: For circle arc with interval 0..OdaPi with HPSMOOTHEVALUATE value of 128, will be generated 64 segments. 
      For circle arc with interval 0..OdaPi/2 with HPSMOOTHEVALUATE value of 128, will be generated 32 segments. 
<table>
 <b>Access Methods</b>
 OdDbDatabase::getSysVar()
 OdDbDatabase::setSysVar()
...
<group TD_SysVars_H>
  */
  ...
  REGVAR_DEF(OdInt16, HPSMOOTHEVALUATE, (0), (), ValidateRange(0, 32767))
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbHostAppServices::getHPNEWDRAW()
   OdDbHostAppServices::setHPNEWDRAW()
  </table>

<group TD_SysVars_D>
  */
  REGVAR_DEF(bool, HPNEWDRAW, (1), (), ValidateBOOL())
...
/**
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbHostAppServices::getPLINECACHE()
   OdDbHostAppServices::setPLINECACHE()
  </table>
...
*/
/**
  <title DxfTextAdjustAlignment>
  <toctitle DxfTextAdjustAlignment>
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbHostAppServices::getDxfTextAdjustAlignment()
   OdDbHostAppServices::setDxfTextAdjustAlignment()
  </table>
...
*/
/**
<title VerticalApplicationsMode>
<toctitle VerticalApplicationsMode>

<table>
<b>Type</b>            OdUInt32
<b>Initial value</b>   0xFFFFFFFB
<b>Read-Only</b>       No
<b>Saved In</b>        Registry
<b>Versions</b>        N/A
</table>

The VerticalApplicationsMode variable controls the behavior of vertical applications.
If the bit is set, the application creates its default objects in every drawing. 
If not set, the application does not create its default objects.
This also affects hatch rendering: an empty stroke hatch is rendered as a solid fill for Architecture SDK.
By default the bit is set to 0 for ODA Mechanical SDK.
...
OdDbDatabase::setSysVar()
&nbsp;
OdDbHostAppServices::getVerticalApplicationsMode()
OdDbHostAppServices::setVerticalApplicationsMode()
</table>

<group TD_SysVars_V>
*/
REGVAR_DEF(OdUInt32,             VerticalApplicationsMode,     (0xFFFFFFFB),                    (),      ValidateNone())
...
/**
<title HonourLockedLayer>
<toctitle HonourLockedLayer>
...
The HonourLockedLayer variable controls whether entities on locked layers are opened for writing.
If HonourLockedLayer is true, entities on locked layers cannot be opened for writing and OdDbObjectId::openObject returns eOnLockedLayer.
...
OdDbDatabase::setSysVar()
&nbsp;
OdDbHostAppServices::getHonourLockedLayer()
OdDbHostAppServices::setHonourLockedLayer()
</table>
...
*/
/**
<title TableIndicatorColor>
<toctitle TableIndicatorColor>

<table>
<b>Type</b>            OdUInt32
<b>Initial value</b>   0xC2ADADAD
<b>Read-Only</b>       No
<b>Saved In</b>        Registry
<b>Versions</b>        N/A
</table>
...
OdDbDatabase::setSysVar()
&nbsp;
OdDbHostAppServices::getTableIndicatorColor()
OdDbHostAppServices::setTableIndicatorColor()
</table>
...
/**
<title FieldIndicatorColor>
<toctitle FieldIndicatorColor>

<table>
<b>Type</b>            OdUInt32
<b>Initial value</b>   0xC2C0C0C0
<b>Read-Only</b>       No
<b>Saved In</b>        Registry
<b>Versions</b>        N/A
</table>
...
OdDbDatabase::setSysVar()
&nbsp;
OdDbHostAppServices::getFieldIndicatorColor()
OdDbHostAppServices::setFieldIndicatorColor()
</table>

<group TD_SysVars_T>
*/
REGVAR_DEF(OdUInt32,            FieldIndicatorColor,          0xC2C0C0C0,                 0xC2C0C0C0,      ValidateNone())
...
*/
/**
<title PDFIMPORTIMAGEPATH>
<toctitle PDFIMPORTIMAGEPATH>

<table>
<b>Type</b>            OdString
<b>Initial value</b>   OD_T("")
<b>Read-Only</b>       No
<b>Saved In</b>        Registry
<b>Versions</b>        N/A
</table>
...
OdDbDatabase::setSysVar()
&nbsp;
OdDbHostAppServices::getPDFIMPORTIMAGEPATH()
OdDbHostAppServices::setPDFIMPORTIMAGEPATH()
</table>
...
*/
/**
<title PartialViewingMode>
<toctitle PartialViewingMode>
...
OdDbDatabase::setSysVar()
&nbsp;
OdDbHostAppServices::getPartialViewingMode()
OdDbHostAppServices::setPartialViewingMode()
</table>
...
*/
/**
<title LineType3dPline>
<toctitle LineType3dPline>
...
OdDbDatabase::setSysVar()
&nbsp;
OdDbHostAppServices::getLineType3dPline()
OdDbHostAppServices::setLineType3dPline()
</table>

<group TD_SysVars_P>
*/
REGVAR_DEF(bool, LineType3dPline, (false), (), ValidateBOOL())
...
OdDbDatabase::setSysVar()
&nbsp;
OdDbHostAppServices::getXREFREGAPPCTL()
OdDbHostAppServices::setXREFREGAPPCTL()
</table>
...
/**
  <title TRACEPAPERCTL>
  <toctitle TRACEPAPERCTL>

  <table>
   <b>Type</b>            OdUInt8
   <b>Initial value</b>   20
   <b>Range</b>           0 ... 50
   <b>Read-Only</b>       No
   <b>Saved In</b>        Registry
   <b>Versions</b>        23.XX+
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbHostAppServices::getTRACEPAPERCTL()
   OdDbHostAppServices::setTRACEPAPERCTL()
  </table>

<group TD_SysVars_T>
  */
  //<dom_var_def>OdUInt8 TRACEPAPERCTL;
  REGVAR_DEF(OdUInt8, TRACEPAPERCTL, (20), (), ValidateRange(0, 50))

    /**
  <title TRACEFADECTL>
  <toctitle TRACEFADECTL>

  <table>
   <b>Type</b>            OdUInt8
   <b>Initial value</b>   40
   <b>Range</b>           0 ... 90
   <b>Read-Only</b>       No
   <b>Saved In</b>        Registry
   <b>Versions</b>        23.XX+
  ...
  TRACEFADECTL controls the opacity when TRACEMODE is active. 
  If TRACEMODE is 1 (Trace open to view) - opacity affects only the trace drawing objects.
  If TRACEMODE is 2 (Trace open to edit) - opacity affects only the host drawing objects.
  The bigger the value, the more transparent the geometry.
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbHostAppServices::getTRACEFADECTL()
   OdDbHostAppServices::setTRACEFADECTL()
  </table>

<group TD_SysVars_T>
  */
  //<dom_var_def>OdUInt8 TRACEFADECTL;
    REGVAR_DEF(OdUInt8, TRACEFADECTL, (40), (), ValidateRange(0, 90))
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbHostAppServices::getTRACEOSNAP()
   OdDbHostAppServices::setTRACEOSNAP()
  </table>

<group TD_SysVars_T>
  */
  //<dom_var_def>OdUInt8 TRACEOSNAP;
    REGVAR_DEF(OdUInt8, TRACEOSNAP, (0), (), ValidateRange(0, 1))

    /**
  <title VISRETAINMODE>
  <toctitle VISRETAINMODE>
  ...
  VISRETAINMODE controls the behavior of the VISRETAIN system variable when it's active.
  VISRETAINMODE is a combination of the bit values described below:
  <table>
   <b>Value</b>   <b>Description</b>
   0              No settings are synchronized (default VISRETAIN behaviour).
   1              On/Off synchronized.
   2              Freeze synchronized.
   4              Lock synchronized.
   8              Plot synchronized.
  ...
  <table>
   ...
   OdDbDatabase::setSysVar()
   &nbsp;
   OdDbHostAppServices::getVISRETAINMODE()
   OdDbHostAppServices::setVISRETAINMODE()
  </table>

<group TD_SysVars_T>
  */
  //<dom_var_def>OdInt16 VISRETAINMODE;
    REGVAR_DEF(OdInt16, VISRETAINMODE, (0), (), ValidateRange(-2047, 2047))
