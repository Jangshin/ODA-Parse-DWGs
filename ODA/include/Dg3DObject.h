...
TG_EXPORT OdResult odDgGetObjectMesh(OdDgElement *pElm, double dSurfaceTolerance, OdGePoint3dArray& vertexArray, 
  OdInt32Array& faceArray, OdGiFaceData*& faceData, bool bCreateTriangles = false, bool bCreateTrianglesForPolygonsWithHoles = false);

TG_EXPORT OdResult odDgGetObjectMesh(OdDgElement *pElm, const wrTriangulationParams& triangulationParams, OdGePoint3dArray& vertexArray,
  OdInt32Array& faceArray, OdGiFaceData*& faceData, bool bCreateTriangles = false, bool bCraeteTrianglesForPolygonsWithHoles = false);
