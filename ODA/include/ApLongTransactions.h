...
public:
  ...
  /** \details
   ...
   \param lt [in] Long transaction that this notification refers to.
   \param originList [in, out]  List of objects passed to OdApLongTransactionManager::checkOut(). Can be modified.
  */
  virtual void beginCheckOut(OdDbLongTransaction& lt, OdDbObjectIdArray& originList);
