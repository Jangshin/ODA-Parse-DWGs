...
#define TD_SHORT_STRING_VER_S   "25.4"
#define TD_SHORT_STRING_VER_W  L"25.4"

#define TD_PRODUCT_VER_STR_S   "25.4.0.0"
#define TD_PRODUCT_VER_STR_W  L"25.4.0.0"
...
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"_lic6"
#elif _MSC_VER == 1310
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"_lic7"
#elif _MSC_VER == 1400
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"_lic8"
#elif _MSC_VER == 1500
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"_lic9"
#elif _MSC_VER == 1600
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"_lic10"
#elif _MSC_VER == 1700
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"_lic11"
#elif _MSC_VER == 1800
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"_lic12"
#elif _MSC_VER == 1900
#define TD_DLL_VERSION_SUFFIX_STR L"_" TD_STRINGIZE(TD_SHORT_STRING_VER_S) L"_lic14"
#elif _MSC_VER < 1920
#define TD_DLL_VERSION_SUFFIX_STR L"_" TD_STRINGIZE(TD_SHORT_STRING_VER_S) L"_lic15"
#elif _MSC_VER < 1930
#define TD_DLL_VERSION_SUFFIX_STR L"_" TD_STRINGIZE(TD_SHORT_STRING_VER_S) L"_lic16"
#elif _MSC_VER < 1940
#define TD_DLL_VERSION_SUFFIX_STR L"_" TD_STRINGIZE(TD_SHORT_STRING_VER_S) L"_lic17"
#elif _MSC_VER < 1950 // Version 17.10.0 Preview 2.0
#define TD_DLL_VERSION_SUFFIX_STR L"_" TD_STRINGIZE(TD_SHORT_STRING_VER_S) L"_lic17"
#else
...
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"_licb6"
#elif __BORLANDC__ >= 0x0610 && __BORLANDC__ <= 0x0619
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"_licb9"
#elif __BORLANDC__ >= 0x0620 && __BORLANDC__ <= 0x0629
#define TD_DLL_VERSION_SUFFIX_STR L"_"##TD_STRINGIZE(TD_SHORT_STRING_VER_S)##L"_licb10"
#else
#error "Unsupported compiler for suffixed version"
#endif
#endif
