...
public:
  ...
  */
  ...
  /** \details
    ...
    execution.
    \remarks
    It doesn't return dublicated intersections like it implemented in ObjectArx.
  */
  ...
  */
  ...
  /** \details
    ...
    \returns eOk if the mesh is successfully negated, or a corresponding error code
    otherwise.
  */
  OdResult negate();
  ...
  /** \details
    ...
    \param result [out] Receives true if the mesh is watertight, or false otherwise.
    \returns eOk if the operation completed successfully, or an appropriate
    error code otherwise.
  */
  ...
  /** \details
    ...
    \param result [out] Receives the number of faces for the base level. Receives 0 if the mesh has not been initialized yet.
    \returns eOk if the operation completed successfully, or an appropriate
    error code otherwise.
  */
  ...
  */
  ...
  /** \details
    ...
    \param result [out] Receives the number of edges for the base level. Receives 0 if the mesh has not been initialized yet.
    \returns eOk if the operation completed successfully, or an appropriate
    error code otherwise.
  */
  ...
  */
  ...
  /** \details
    Calculates normals for all vertices of the current SubDMesh entity.
    ...
    getVertexNormalArray and getNormalArray are independent and operate with different normal arrays.
  */
  ...
  */
  ...
  /** \details
    ...
    \remarks
    The mesh should not have self-intersections and zero area faces.
    The case when bConvertAsSmooth == true and optimize == true is not
    implemented yet.
  */
  ...
  */
  ...
  /** \details
    ...
    \remarks getVertexNormalArray and getNormalArray are independent and operate with different normal arrays.
  */
  ...
  */
  ...
  /** \details
    ...
    \remarks
    setVertexNormalArray and getNormalArray are independent and operate with different normal arrays.
  */
  OdResult setVertexNormalArray(const OdGeVector3dArray& arrNorm);
  ...
  /** \details
    ...
    error code otherwise.
  */
  OdResult setVertexTextureArray(const OdGePoint3dArray& arrPts);
  ...
  /** \details
    ...
    error code otherwise.
  */
  OdResult setVertexColorArray(const OdCmEntityColorArray& arrColor);
  ...
  /** \details
    ...
    \remarks clearVertexNormalArray and getNormalArray are independent and operate with different normal arrays.
  */
