...
/** \details
  ...
  */
  ...
  /** \details
    Returns the NURBS data for this Spline entity based on genegated Ge curve.
...
*/
  ...
  virtual OdResult setFromOdGeNurbCurve(const OdGeNurbCurve2d& geCurve, const OdGeTol& tol = OdGeContext::gTol, bool bKeepOpen = true);
...
*/
  ...
  virtual OdResult setFromOdGeNurbCurve(const OdGeNurbCurve3d& geCurve, OdGeVector3d *normal = NULL, const OdGeTol& tol = OdGeContext::gTol, bool bKeepOpen = true);
