...
public:
  ...
  \param dCrossUnitsScale [in] Scale for cross units conversion ( from working units to
  \UORs, or from UORs to working units )
  ...
  */
  ...
  virtual bool getAnnotationScaleAvailbleFlag() const;
  virtual void setAnnotationScaleAvailbleFlag( bool bSet );

  virtual OdDgElementIdArray getDependedSharedCellReferences() const;
};
