...
/** \details
    ...
    \param objectId [in]  Object ID to be not faded.
...
*/
  ...
  */
  ...
  /** \details
    Checks whether an object with the specified ID needs to fade.

    \param objectId [in]  Object ID to check.

    \returns true if and only if the specified object ID needs to fade.
*/
  bool needsFading(OdDbObjectId
    ObjectId) const;
