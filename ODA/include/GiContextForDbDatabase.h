...
private:
  enum
  {
    ...
    kVpGeomCSCompatibility           = 4096,
    kLastFlag                        = kVpGeomCSCompatibility
  };
...
public:
  ...
  */
  ...
  virtual OdUInt32 drawableFilterFunction(OdIntPtr functionId, const OdGiPathNode* pPathNode, OdUInt32 nFlags) ODRX_OVERRIDE;
  ...
  */
  ...
  /** \details
    ...
    \param csType [in]  Input geometry primitive coordinates system.
  ...
  */
  ...
  /** \details
    ...
    \param bEnable [in]  Set to true to enable compatibility mode (polylineEye/polygonEye/polylineDc/polygonDc
                         geometry primitives work in WCS). Set to false (default) to disable compatibility mode
                         (polylineEye/polygonEye work in ECS and polylineDc/polygonDc work in normalized DCS)
  */
