...
public:
  ...
  typedef typename std::allocator_traits<T>::difference_type difference_type;
  typedef typename std::allocator_traits<T>::pointer         pointer;
  typedef typename std::allocator_traits<T>::const_pointer   const_pointer;
  typedef typename std::allocator_traits<T>::reference       reference;
  typedef typename std::allocator_traits<T>::const_reference const_reference;
  typedef typename std::allocator_traits<T>::value_type      value_type;
