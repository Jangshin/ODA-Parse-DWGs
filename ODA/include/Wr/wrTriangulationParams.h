...
public:
  ...
  */
  ...
  /** \details
    Returns true if the triangulation parameters except surfaceTolerance are strong equal and surfaceTolerance is equal with tolerance.

    \param other [in]  triangulation parameters.
    \param dTol [in]  Geometric tolerance.
  */
  bool isEqualTo(const wrTriangulationParams& other, double dTol) const
  {
    return other.maxNumGridLines == maxNumGridLines
      && other.maxFacetEdgeLength == maxFacetEdgeLength
      && other.normalTolerance == normalTolerance
      && OdEqual(other.surfaceTolerance, surfaceTolerance, dTol)
      && other.gridAspectRatio == gridAspectRatio
      && other.PointsPerEdge == PointsPerEdge
      && other.BetweenKnots == BetweenKnots
      && other.bRecalculateSurfaceTolerance == bRecalculateSurfaceTolerance;
