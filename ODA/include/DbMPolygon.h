...
public:
  ...
  */
  ...
  /** \details
    ...
    \returns * eAmbiguousInput &mdash; if excludeCrossing is true and there are crosses
    between loops; 
    * eInvalidIndex &mdash; if loop index is out of range for number of loops;
    * eOk &mdash; if a loop replaced successfully.
  ...
  */
  ...
  /** \details
    Replaces a polygon loops in the specified positions.
    ...
    \returns * eAmbiguousInput &mdash; if excludeCrossing is true and there are crossings
    between loops; 
    * eInvalidInput &mdash; if 'loopIndices' is empty or size not equal vertices size or bulges size;
    * eInvalidIndex &mdash; if loop index is out of range for number of loops;
    * eOk &mdash; if loops replacing of polygon is successfully.
 ...
 */
  ...
  */
  ...
  /** \details
    ...
    \returns The OdSmartPtr class for the OdDbEntity object pointer, or NULL otherwise.
  */
