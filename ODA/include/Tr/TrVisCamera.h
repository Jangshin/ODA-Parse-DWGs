...
public:
  ...
  void setContext(const OdTrVisCamera &cam2, const OdTrVisSurfaceDef *pSurface = NULL, const OdTrVisViewportShadingDef *pViewportShading = NULL,
                                             const OdTrVisViewportClipDef *pViewportClip = NULL, const OdTrVisExtentsDef *pExtents = NULL)
  { setContext(pSurface ? pSurface : cam2.m_pSurfaceDef, pViewportShading ? pViewportShading : cam2.m_pViewportShadingDef,
               pViewportClip ? pViewportClip : cam2.m_pViewportClipDef, pExtents ? pExtents : cam2.m_pExtentsDef);
  }
