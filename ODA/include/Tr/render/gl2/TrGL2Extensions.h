...
// Cube maps support (kExtensionCubeMap)
...
// Seampless cube maps filtration support (kExtensionCubeMapSeamless)
#ifndef GL_TEXTURE_CUBE_MAP_SEAMLESS
#define GL_TEXTURE_CUBE_MAP_SEAMLESS      0x884F
#endif // GL_TEXTURE_CUBE_MAP_SEAMLESS

// Unpack subimage support (kExtensionUnpackSubimage)
...
// Pixel buffer object (kExtensionPBO)
