...
class OdTrRndRenderModuleStub : public OdTrRndRenderModule
{
  public:
    ...
    // Check renderer version
    virtual OdUInt32 checkRendererVersion(OdTrVisRenderClient * /*pRenderClient*/, OdUInt32 /*nCheckVersion*/ = 0, OdTrVisRendition * /*pRendition*/ = NULL) const
    { return 0; }
    // Renderer information accessor
    virtual OdAnsiString takeRendererInfo(OdTrVisRenderClient * /*pRenderClient*/, OdTrVisRendition * /*pRendition*/ = NULL) const
    { return OdAnsiString(); }
