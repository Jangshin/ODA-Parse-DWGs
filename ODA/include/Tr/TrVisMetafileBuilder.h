...
enum OdTrVisEnabledVertexData
{
  kVDNone               = 0,
  kVDColor              = 1,
  kVDNormal1            = 2 << unsigned(OdTrVisNormalType::kPrimary),
  kVDNormal2            = 2 << unsigned(OdTrVisNormalType::kSecondary),
  kVDBumpNormalT        = 2 << unsigned(OdTrVisNormalType::kBumpMappingT),
  kVDBumpNormalB        = 2 << unsigned(OdTrVisNormalType::kBumpMappingB),
  kVDNormMapTNormal     = 2 << unsigned(OdTrVisNormalType::kNormalMapT),
  kVDNormMapBNormal     = 2 << unsigned(OdTrVisNormalType::kNormalMapB),
  kVDDiffuseTexCoord    = 128 << unsigned(OdTrVisTextureType::kDiffuse),
  kVDOpacityTexCoord    = 128 << unsigned(OdTrVisTextureType::kOpacity),
  kVDBumpMapTexCoord    = 128 << unsigned(OdTrVisTextureType::kBumpMap),
  kVDSpecularTexCoord   = 128 << unsigned(OdTrVisTextureType::kSpecular),
  kVDRefractionTexCoord = 128 << unsigned(OdTrVisTextureType::kRefraction),
  kVDEmissionTexCoord   = 128 << unsigned(OdTrVisTextureType::kEmission),
  kVDNormMapTexCoord    = 128 << unsigned(OdTrVisTextureType::kNormalMap),
  kVDRoughnessTexCoord  = 128 << unsigned(OdTrVisTextureType::kRoughness),
  kVDCutoutsTexCoord    = 128 << unsigned(OdTrVisTextureType::kCutouts),
  kVDReflectionTexCoord = 128 << unsigned(OdTrVisTextureType::kReflection),
  kVDDepth              = 131072
};
