...
class OdTrVisRenderClient
{
  public:
    enum AntiAliasingMode
    {
      ...
      kAntiAliasLines3d  = (1 << 1)  // Lines anti-aliasing in 3d.
    };
    enum BlendingMode
    {
  ...
  public:
    ...
    virtual bool hasDirectRenderBuffer(bool* /*bTransparent*/ = NULL) const { return false; }
    ...
    virtual OdUInt32 getSelectionStyle(OdUInt32 nStyle, OdTrVisSelectionStyle &style) const { style.setForStippling(); return (nStyle < 1) ? 1 : 0; }
...
class OdTrVisRenderClientPropsDic
{
  ...
  public:
    ...
    OdRxObjectPtr getPropAt(OdUInt32 nProp) const { return m_dic[nProp].m_pValue; }
    void setPropAt(OdUInt32 nProp, OdRxObjectPtr pValue) { m_dic[nProp].m_pValue = pValue; }
    ...
    OdRxObjectPtr getProp(const OdChar *pPropName) const
    {
      ...
      if (nProp == 0xFFFFFFFF) return OdRxObjectPtr();
...
class OdTrVisRenderClientPropImpl : public OdTrVisRenderClient
{
  ...
  public:
    ...
    {
      return m_props.getProp(pPropName).get();
    }
...
class OdTrVisRenderClientWrapper : public RCInterface
{
  ...
  public:
    ...
    {
      if (hasRedirection())
        return redirection()->getPropertyObject(pPropName);
    ...
    {
      if (hasRedirection())
        redirection()->setPropertyObject(pPropName, pValue);
    }
    ...
    {
      if (hasRedirection())
        return redirection()->rasterImageContentsHighlight();
      return false;
    }
    ...
    {
      if (hasRedirection())
        return redirection()->hasDirectRenderBuffer(bTransparent);
      return false;
    }
    ...
    {
      if (hasRedirection())
        return redirection()->getSelectionStyle(nStyle, style);
      return RCInterface::getSelectionStyle(nStyle, style);
    }
