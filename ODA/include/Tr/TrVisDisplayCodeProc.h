...
class OdTrVisDisplayCodeKeeper
{
  public:
    ...
    { pushMarkers<TArray>(arry, pTfBranch, kTrVisTransformBranch); }
    // Drawing order
    template <typename TArray>
  ...
  public:
    ...
    { OdUInt32 nSteps = 1;
      switch (dispCode) { case OdTrVisRendition::kDisplayCodePushMatrix: nSteps += sizeof(OdGeMatrix3d) / sizeof(double); break;
                          ...
                          case OdTrVisRendition::kDisplayCodeHlMarkers: case OdTrVisRendition::kDisplayCodeVsMarkers: case OdTrVisRendition::kDisplayCodeTfMarkers:
