...
struct OdTrVisPropertyDef
{
  ...
  UnderlyingDataType underlyingDataType() const
  {
    switch (m_propType)
    {
      ...
      case kTfBranchProperty:    return kIdProperty;
...
// OdTrVisPropertyDef destructor
inline void OdTrVisPropertyDef::operator delete(void *p)
{
  switch (reinterpret_cast<OdTrVisPropertyDef*>(p)->underlyingDataType())
  {
    case kBooleanProperty: reinterpret_cast<OdTrVisBooleanPropertyDef*>(p)->~OdTrVisBooleanPropertyDef(); break;
    case kIdProperty:      reinterpret_cast<OdTrVisIdPropertyDef*>(p)->~OdTrVisIdPropertyDef();           break;
    case kStringProperty:  reinterpret_cast<OdTrVisStringPropertyDef*>(p)->~OdTrVisStringPropertyDef();   break;
    case kMatrixProperty:  reinterpret_cast<OdTrVisMatrixPropertyDef*>(p)->~OdTrVisMatrixPropertyDef();   break;
  }
  ::odrxFree(p);
}
