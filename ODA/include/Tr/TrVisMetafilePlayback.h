...
class OdTrVisMetafilePlaybackCallback
{
  public:
    ...
    virtual const OdGeMatrix3d *metafileOcsTransform(const OdGeMatrix3d ** /*pInverse*/ = nullptr) { return nullptr; }
...
class OdTrVisMetafilePlayback
{
  ...
  public:
    ...
    inline void setPrimitiveDrawMask(OdUInt32 mask)
    {
      m_primDrawMask = mask;
    }
    inline OdUInt32 primitiveDrawMask() const
    {
      return m_primDrawMask;
    }
