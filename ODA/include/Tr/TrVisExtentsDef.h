...
struct OdTrVisExtentsDef
{
  ...
  bool operator ==(const OdTrVisExtentsDef &extents) const
  {
    return m_sceneExtents.minPoint().isEqualTo(extents.m_sceneExtents.minPoint()) &&
           m_sceneExtents.maxPoint().isEqualTo(extents.m_sceneExtents.maxPoint()) &&
           m_realExtents.minPoint().isEqualTo(extents.m_realExtents.minPoint()) &&
           m_realExtents.maxPoint().isEqualTo(extents.m_realExtents.maxPoint());
  }
  bool operator !=(const OdTrVisExtentsDef &extents) const
  {
    return !m_sceneExtents.minPoint().isEqualTo(extents.m_sceneExtents.minPoint()) ||
