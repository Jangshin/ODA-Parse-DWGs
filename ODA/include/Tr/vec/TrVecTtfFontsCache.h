...
class OdTrVecTtfFontsCache : public OdStaticRxObject<OdTtfFontsCache>, public OdTrVisTtfFontsCacheClient
{
  ...
  public:
    ...
    \param uChar     [in] Property value to set.
    \param pSideMult [out] Distance between this and previous character.
  ...
  protected:
    ...
    */
    ...
    {
      return const_cast<OdTrVecTtfFontsCache*>(this)->getCharTexture((const void*)pFont, uChar, pSideMult);
    }
};
