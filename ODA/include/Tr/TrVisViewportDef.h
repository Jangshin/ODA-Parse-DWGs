...
struct OdTrVisViewportLineweightsDef
{
  ...
  void setDefault()
  {
    ...
    m_lineweightsEnum2x.setPhysicalLength(0);
  ...
  void setLineweightsEnum2(const OdUInt16Array &lwdEnum) { m_lineweightsEnum2x = lwdEnum; }
  const OdUInt16 *lineweightsEnum2() const { return m_lineweightsEnum2x.getPtr(); }
  OdUInt32 numLineweightsEnum() const { return (m_lineweightsEnum2x.empty()) ? m_lineweightsEnum.size() : m_lineweightsEnum2x.size(); }
  OdUInt32 getLineweight(int nLwd) const { return (m_lineweightsEnum2x.empty()) ? OdUInt32(lineweightsEnum()[nLwd]) : OdUInt32(lineweightsEnum2()[nLwd]); }
  bool hasLineweightsEnum() const { return !m_lineweightsEnum.isEmpty() || !m_lineweightsEnum2x.isEmpty(); }
  bool hasLineweightsEnum2() const { return !m_lineweightsEnum2x.isEmpty(); }
