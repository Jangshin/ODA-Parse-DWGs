...
struct OdTrVisMiniVec3d : public OdTrVisMiniVec2d<DataType>
{
  ...
  template <typename VecType>
  OdTrVisMiniVec3d(const VecType &vec) : OdTrVisMiniVec2d<DataType>((DataType)vec.x, (DataType)vec.y), z((DataType)vec.z) { }
...
struct OdTrVisMiniVec4d
{
  ...
  explicit OdTrVisMiniVec4d(const DataType* v)
...
{
  return OdTrVisMiniVec4d<DataType>(v1.x + v2.x, v1.y + v2.y, v1.z + v2.z, v1.w + v2.w);
}

template <typename DataType, typename ScalarType>
OdTrVisMiniVec4d<DataType> operator*(const OdTrVisMiniVec4d<DataType>& vec, ScalarType value)
{
  return OdTrVisMiniVec4d<DataType>(vec.x * value, vec.y * value, vec.z * value, vec.w * value);
}

template <typename DataType, typename ScalarType>
OdTrVisMiniVec4d<DataType> operator*(ScalarType value, const OdTrVisMiniVec4d<DataType>& vec)
{
  return vec * value;
}
...
typedef OdTrVisMiniVec4d<float> OdTrVisVector4df;
