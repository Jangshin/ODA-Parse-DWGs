...
public:
  ...
  */
  ...
  /** \details
    ...
    \param sSource [out] CRS's source.
  ...
  */
  ...
  /** \details
    ...
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  static OdResult createAll(const OdGePoint3d& geoPt, OdArray<OdDbGeoCoordinateSystemPtr>& arrCoordSys);
  /** \details
    Creates and returns a new OdDbGeoCoordinateSystem object for every existing, 
  ...
  */
  static OdResult createAll(OdArray<OdDbGeoCoordinateSystemPtr>& arrCoordSys,
