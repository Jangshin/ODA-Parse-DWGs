...
public:
  ...
  */
  ...
  /** \details
    Returns the number of subentities of specified root entity currently selected.
    If root entity is not specified then returns number of all selected subentities.

    \param rootEntId [in]  specified root entity, may be 0. 
  */
  virtual OdUInt32 subentCount(OdDbStub* /*rootEntId*/ = 0) const { return 0; }
