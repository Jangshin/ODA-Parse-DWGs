...
TG_EXPORT bool isCellHeaderElement(const OdDgElement* pElm);
...
*/
  ...
  virtual OdResult getRangeExtents(OdGeExtents2d& extRange) const;
};
...
*/
  ...
  virtual OdResult getRangeExtents(OdGeExtents3d& extRange) const;
};
...
class TG_EXPORT OdDgAnnotationCellHeader2d : public OdDgCellHeader2d
{
  ...
  virtual void setUseAnnotationScaleFlag( bool bSet, double dAnnotationScale = 0, bool bRescaleGeometry = true );
