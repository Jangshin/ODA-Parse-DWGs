...
{
public:
  GE_OPERATORS_OVERRIDE_3D(OdGeCurve3d);
  ...
  */
  ...
  /** \details
    ...
    of the interval is returned. In case of range == NULL
    closestPointTo(point, param, range, tol) is called where range is a native curves
