...
public:
  ...
  /** \details
    ...
    \param options [in] Break options.
    \param eps [in] Maximum tolerance of the initial vertices.
    \returns smart pointer to the first contour after breaking.
  */
  ...
  /** \details
    ...
    \param tol [out] Pointer to the output tolerance of the contour square.
    \param eps [in] Maximum tolerance of the initial vertices.
    \param isAccurately [in] Flag indicating calculation with more precision.
    \returns the square value of the contour.
  */
  ...
  /** \details
    Checks if there are invalid holes.

    \returns true.if the contour has holes that have been ignored, otherwise false
  */
  bool hasInvalidHoles() const { return m_bInvalidHoles; }
