...
/** \details
    ...
    \remarks
    Each instance of OdGeExternalBoundedSurface is composed of an instance
...
public:
  ...
  */
  ...
  /** \details
    ...
    \param source [in]  External bounded surface to copy.
  */
  OdGeExternalBoundedSurface(
  ...
  */
  OdGeExternalBoundedSurface& setToOwnSurface();
   ...
   /** \details
     ...
     \param extBoundSurf [in]  External bounded surface to assign.
