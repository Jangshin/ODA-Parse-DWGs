...
struct GE_TOOLKIT_EXPORT OdGeUvBox
{
  ...
  */
  ...
  /** \details
    Comparison operator for the OdGeUvBox object.

    \param otherUvBox [in]  Other uv box.

    \returns
    A boolean value that indicates whether the input uv box is identical to this uv box.
  */
  bool operator ==(const OdGeUvBox& otherUvBox) const;
};
