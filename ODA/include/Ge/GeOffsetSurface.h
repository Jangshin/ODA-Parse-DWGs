...
{
public:
  GE_OPERATORS_OVERRIDE_3D(OdGeOffsetSurface);
  ...
  */
  ...
  /** \details
    Tries to simplify this surface and returns a converted copy of this surface if succeed.
  ...
  */
  ...
  /** \details
    ...
    \param surface [in]  Offset surface to assign.
    
    \returns
    Reference to this OdGeOffsetSurface object.
  */
