...
{
public:
  GE_OPERATORS_OVERRIDE_2D(OdGeLinearEnt2d);
  ...
  */
  ...
  /** \details
    Returns a reference to an infinite line collinear with this linear entity.
  ...
  */
  ...
  /** \details
    ...
    \param line [in]  Linear entity to assign.
