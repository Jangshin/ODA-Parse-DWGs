...
public:
  ...
  */
  ...
  /** \details
    ...
    Profile curve is specified in local coordinates.
    Z coordinate of profile curve goes along axis of rotation pAxis.
    X coordinate of profile curve goes orthogonal to the rotation axis.
    Y coordinate of profile curve is ignored.
  */
  OdGeRevolvedSurface(
