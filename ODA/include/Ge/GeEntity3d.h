...
//DOM-IGNORE-END
  ...
  */
  ...
  /** \details
    ...
    \param entity [in]  Other entity to compare.
  ...
  */
  ...
  /** \details
    ...
    \param object [in]  Entity to be compared
    \param tol    [in]  Geometric tolerance.
    
    \returns
    true if and only if both entities are of the same type, have the same point set within the 
