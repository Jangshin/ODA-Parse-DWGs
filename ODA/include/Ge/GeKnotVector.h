...
public:
  ...
  */
  ...
  /** \details
    ...
    \param endIndex [in]  Index after the last knot to be removed.
  */
  ...
  */
  ...
  /** \details
    ...
    \remarks
    Will never insert value at position 0 in non-empty vector.
    If we have vector with any single value, insertion will be after this one no matter inserted value >, < or = to this value
    Examples: 
    OdGeKnotVector v; v.insert(1); v.insert(-100). Result will be {1, -100}.
    OdGeKnotVector v; {1, 5, 12, 30}; v.insert(-1); v.insert(50); v.insert(8); Result will be {1, -1, 5, 8, 12, 30, 50};
  */
  ...
  /** \details
    ...
    \remarks
    Will never insert value at position 0 and n-1 if vector's size >= 2. 
    If we have empty vector exception will be thrown. 
    If we have vector with any single value, insertion will be before this one no matter inserted value >, < or = to this value
    Examples:
    OdGeKnotVector v{1}; v.insert(5). Result will be {5, 1}. v.insert(10). Result will be {5,10,1}; 
    OdGeKnotVector v; {1, 5, 12, 30}; v.insert(-1); v.insert(50); v.insert(8); Result will be {1, -1, 5, 8, 12, 50, 30};
  */
  OdGeKnotVector& insertIn(
    double param);
