...
{
public:
  GE_OPERATORS_OVERRIDE_2D(OdGeCurve2d);
  ...
  */
  ...
  /** \details
    ...
    \param param [out]  Parameter of closest point.
    ...
    In case of range == NULL closestPointTo(point, param, range, tol) is called where
  ...
  */
  ...
  /** \details
    ...
    \remarks
    This function is the same as getClosestPointTo().
    By default this function converts curves to 3d and calls 3d implementation. Should be
    implemented in derived classes.
  */
  OdGePoint2d closestPointTo(
  ...
  /** \details
    ...
    \remarks
    By default this function converts curve to 3d and calls 3d implementation. Should be
    implemented in derived classes.
  */
  ...
  */
  ...
  /** \details
    ...
    \returns eOk on success or error code otherwise.
