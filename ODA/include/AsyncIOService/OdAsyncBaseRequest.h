...
#ifndef _OD_ASYNC_BASE_REQUEST__INCLUDED_
#define _OD_ASYNC_BASE_REQUEST__INCLUDED_
...
public:
  ...
  */
  OdAsyncBaseRequest()
    : m_requestDescriptor(0), m_receiverDescriptor(0), m_bAsyncNotification(true)
  {
  }
