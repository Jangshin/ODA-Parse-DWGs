...
protected:
  OdDbGeoDataChunks();
public:
  virtual void setGsNode(OdGsCache* pGsNode) override { m_pGsNode = pGsNode; }
  virtual OdGsCache* gsNode() const override { return m_pGsNode; }
  virtual bool isPersistent() const override { return false; }
  virtual OdDbStub* id() const override { return 0; }
...
public:
  ...
  virtual long numRefs() const override { return m_nRefCounter; }
