...
/** \details
    ...
    <group OdRx_Classes> 
*/
class FIRSTDLL_EXPORT OdRxVariant : public OdRxObject, public OdVariant
{
  public:
...
#define ODRXVARVAL_CONSTR(type, setter) \
  ...
  ODRXVARVAL_CONSTR(const OdUInt64Array&, setUInt64Array)
...
#define ODRXVARVAL_IMPLICIT(type, getter) \
  ...
  ODRXVARVAL_IMPLICIT(OdUInt64Array, getUInt64Array)
