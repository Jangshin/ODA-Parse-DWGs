...
public:
  ...
  */
  ...
  /** \details
  This enum represents the type of lofted surface. </summary>
  */
  enum LoftSurfaceType
  {
    /** \details
    Created from createLoftedSurface().
    */
    kLoftSurf,
    /** \details
    Created from createBlendSurface().
    */
    kLoftBlendSurf,
    /** \details
    Created from createNetworkSurface().
    */
    kLoftNetworkSurf
  };
