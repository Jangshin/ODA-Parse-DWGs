...
public:
  ...
  */
  ...
  virtual double rdDouble(bool& bInfValue) = 0;
  ...
  virtual OdGePoint2d rdPoint2d(bool& bInfValue) = 0;
  virtual OdGePoint3d rdPoint3d(bool& bInfValue) = 0;
  virtual OdGeVector2d rdVector2d() = 0;
  virtual OdGeVector3d rdVector3d() = 0;
  virtual OdGeQuaternion rdQuaternion() = 0;
  virtual OdString rdUnicodeString(OdInt32 length) = 0;
