...
public:
  ...
  */
  ...
  /** \details
    Returns the object ID of the text style assigned to the identifier.
  */
  ...
  */
  ...
  /** \details
    Gets current section view style to use as default for initialization
    ...
    \returns
    Object ID of the current OdDbSectionViewStyle object
    that defines the appearence of this view symbol.

    \remarks
    This method checks if CVIEWSECTIONSTYLE variable is initialized and checks
    if default OdDbSectionViewStyle object exists in section-view-style dictioinary.
    When init parameter is true, method may create new object in the database
    and initialize CVIEWSECTIONSTYLE variable if necessary.
  */
