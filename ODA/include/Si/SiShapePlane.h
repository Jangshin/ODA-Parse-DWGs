...
struct ODSI_API OdSiHalfSpace : public OdSiShapePlane 
{
  ...
  bool intersects(const OdGePoint3d &origin, const OdGeVector3d &xAxis, const OdGeVector3d &yAxis, const OdGeVector3d &zAxis,
                  const OdGeTol& tol, bool& bContains) const;
};
