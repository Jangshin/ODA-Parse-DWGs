...
namespace PDF3D_ENUMS
{
  ...
  */
  ...
  /** \details
  Enumeration representing the behaviour when exporting color components to PRC.
  */
  enum PrcExportColorComponentBehavior
  {
    /** Export color as is.*/
    kExportAsIs,
    /** Export color as white color.*/
    kExportWhite,
    /** Export color as uninited color.*/
    kExportNotInited,
  };
