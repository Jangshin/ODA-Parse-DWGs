...
namespace dst
{
  ...
  enum OdSmLockStatus
  {
    OdSmLockStatus_UnLocked = 0,
    OdSmLockStatus_Locked_Local = 1,
    OdSmLockStatus_Locked_Remote = 2,
    OdSmLockStatus_Locked_ReadOnly = 4,
    OdSmLockStatus_Locked_NotConnected = 8,
    OdSmLockStatus_Locked_AccessDenied = 16
  };
  ...
  */
  struct SMDLL_EXPORT OdSmDatabase : OdSmComponent
  {
    ...
    virtual void unlockDb(bool bCommit) = 0;
    virtual OdSmLockStatus lockStatus() const = 0;
    virtual bool lockInfo(OdString& userName, OdString& machineName) = 0;
  };
