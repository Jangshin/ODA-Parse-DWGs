...
namespace OdDbModeler { 
  struct OdSectionViewParams;
  struct OdHlrCurvesParams;
}
...
public:
  ...
  */
  ...
  /** \details
    ...
    \param params [in/out] parameters to create curves.
  ...
  */
  ...
  /** \details
    ...
    \returns The true value if successful; false otherwise.
  ...
  */
  ...
  /** \details
    ...
    \returns Returns eOk if the Boolean operation is successful, or an appropriate error
    code otherwise. If ModelerGeometry is NULL, eInvalidInput is returned.
    ...
    Result is stored in this object. Pointer to the other ModelerGeometry object will be modified.
  */
  ...
  */
  ...
  /** \details
    ...
    \returns Returns eOk if the operation is successful, or an appropriate error
    code otherwise.
  */
  ...
  */
  ...
  /** \details
    ...
    intersect the ModelerGeometry object, then the ModelerGeometry object is left
  ...
  */
  ...
  /** \details
    ...
    ModelerGeometry object to be the portion remaining on the negative side of
    ...
    ModelerGeometry object is empty, returns eInvalidInput. If the specified surface
    does not intersect this solid, then this solid and pNegHalfSolid are left unchanged,
    returns eNotApplicable.
  ...
  */
  ...
  /** \details
    ...
    object to be the portion on the positive side of the slicing plane normal.
    ...
    appropriate error code otherwise. If solid is empty, returns eInvalidInput. If the specified plane does not
    intersect this surface, then this surface and pNegHalfSurface are left unchanged, returns eNoIntersections.
  */
  ...
  /** \details
    Slices this ModelerGeometry object with the specified surface and sets the
    object to be the portion on the negative side of the slicing surface normal.
    ...
    \returns eOk if the slicing operation is successfully performed or an
    appropriate error code otherwise. If pSlicingSurface pointer is NULL or the solid is empty,
    returns eInvalidInput. If the specified surface does not intersect this surface, then this surface
    and pNegHalfSurface are left unchanged, returns eNoIntersections.
  */
  ...
  */
  ...
  /** \details
    ...
    \returns eNotImplemented.
  */
  virtual OdResult setMaterialResolver(const OdMaterialResolver *) { return eNotImplemented; }
  ...
  */
  ...
  virtual OdResult createNetworkSurface(const OdArray<OdDb3dProfilePtr>& uProfiles,
                                        const OdArray<OdDb3dProfilePtr>& vProfiles) = 0;
  ...
  */
  ...
  /** \details
    ...
    \param params [in/out] parameters to create section view entities.
  ...
  */
  ...
  /** \details
    ...
    \param arrArrFaces        [in] Array of arrays faces containing faces defined by loops.
    ...
    \remarks
    Each arrArrFaces's face must contain first loop like outer loop, 
    other loops are inner loops.
    \returns
  ...
  */
  virtual OdResult convertTo(const OdGePoint3dArray &arrVertexes, const OdInt32Array &arrEdges, const OdArray<OdInt32Array>& arrArrFaces, OdGiFaceData &fd,
    OdBoolArray &arrFacesColors, OdBoolArray &arrFacesMaterials, OdDbEntity* pEntity) = 0;

  /** \details
    Creates a new OdDbSurface object.
  
    \param aLoopEdges          [in] Array containing loop edges.
    \param aNurbSurface        [in] Array containing Nurb surfaces.
    \param aColors             [in] Array containing face colors.
    \param aMaterials          [in] Array containing face materials.
    \param arrIsFacesColors    [in] True at a particular index means that the face has colors.
    \param arrIsFacesMaterials [in] True at a particular index means that the face has material.
    \param pEntity          [out] Created entity.
    ...
    * eInvalidInput &mdash; if any other error occured.
  */
  virtual OdResult convertTo(const OdArray< OdArray<std::pair<OdUInt64, OdGeNurbCurve3d> > >& aLoopEdges,
    const OdArray<OdGeNurbSurface>& aNurbSurface,
    const OdArray<OdCmEntityColor>& aColors,
    const OdArray < OdDbStub*>& aMaterials,
    const OdBoolArray& arrIsFacesColors,
    const OdBoolArray& arrFacesMaterials,
