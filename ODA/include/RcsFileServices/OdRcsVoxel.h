...
public:
  ...
  */
  ...
  /** \details
    Gets the number of points within the current voxel.
  ...
  */
  ...
  /** \details
    Returns tight extents of the voxel if available.

    \returns
    Tight extents of the voxel.
  */
  virtual OdGeExtents3d getAccumulatedExtents() const
  {
    throw OdError(eNotImplemented);
  }

  /** \details
    Gets the number of points within the current voxel at given level of detail.

    \param LOD [in]  Level of detail.

    \returns
    Number of points at given level of detail.
  */
  virtual OdUInt32 getNumberOfPointsForLOD(OdUInt32 /*LOD*/) const
  {
