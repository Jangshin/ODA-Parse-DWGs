...
OD_MESSAGE_DEF( sidHatchNumSrcBnd,          OD_T("Number of source boundary objects %d"))
...
OD_MESSAGE_DEF( sidLeaderStyleNull,         OD_T("LeaderStyle Id is Null"))
// Text
...
OD_MESSAGE_DEF( sidTextHorizontalMode,      OD_T("Horizontal mode invalid bits"))
OD_MESSAGE_DEF( sidTextVerticalMode,        OD_T("Vertical mode invalid bits"))
// DimAssoc
...
OD_MESSAGE_DEF( sidAssArrPathCurve,         OD_T("Curve of assoc path array is missing"))
...
// SVG export
OD_MESSAGE_DEF(sidEnterFileName, OD_T("Enter file name:"))
OD_MESSAGE_DEF(sidFileToSave, OD_T("Svg file to save"))
OD_MESSAGE_DEF(sidScalableVecGraphics, OD_T("Scalable Vector Graphics (*.svg)|*.svg||"))
OD_MESSAGE_DEF(sidLwScale, OD_T("LineWeight scale <1.0>:"))
OD_MESSAGE_DEF(sidFloatingPntPrecision, OD_T("Floating point precision <6>:"))
OD_MESSAGE_DEF(sidEmptyImageBase, OD_T("ImageBase:"))
OD_MESSAGE_DEF(sidImageBase, OD_T("ImageBase <%ls>:"))
OD_MESSAGE_DEF(sidImageURL, OD_T("ImageURL <./>:"))
OD_MESSAGE_DEF(sidScaleFactor, OD_T("Scale factor (Number of drawing units in 1 SVG pixel) <0.0 (Fit-to-page)>:"))
OD_MESSAGE_DEF(sidOutputHeight, OD_T("Output height (in pixels) <768>:"))
OD_MESSAGE_DEF(sidOutputWidth, OD_T("Output width (in pixels) <1024>:"))
OD_MESSAGE_DEF(sidUseHLRViewport, OD_T("Use hidden line removing for according viewports <YES>:"))
OD_MESSAGE_DEF(sidNoYes, OD_T("NO YES"))
OD_MESSAGE_DEF(sidUseBlendedGraphics, OD_T("Use blended gradients for complex gradient fill <YES>:"))
OD_MESSAGE_DEF(sidSmallSVGPage, OD_T("\nCalculated SVG page size is too small for this scale. Default page size (1024x768) is used."))
OD_MESSAGE_DEF(sidLargeSVGPage, OD_T("\nCalculated SVG page size is too large for this scale. Default page size (1024x768) is used."))
OD_MESSAGE_DEF(sidSVGColorPolicy, OD_T("Color policy (Default|Monochrome|Grayscale) <Default>"))
OD_MESSAGE_DEF(sidSVGColorOption, OD_T("Default Monochrome Grayscale"))
OD_MESSAGE_DEF(sidDefaultImageExt, OD_T("Default image extension <.png>:"))
OD_MESSAGE_DEF(sidGenericFontFamily, OD_T("GenericFontFamily <sans-serif>:"))
