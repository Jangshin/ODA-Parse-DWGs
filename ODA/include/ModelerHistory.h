...
public:  
  ...
  //For internal usage
  virtual OdDb3dSolid::GeomType determineGeomType(OdDbObjectPtr& pHistObj, OdDb3dSolidGeomParams** params, OdDb3dSolid::GeomType requiredType) = 0;
  /** \details
  ...
  \param pSolid [in]  Pointer to the OdDb3dSolid object.
  \returns
