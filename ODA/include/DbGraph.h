...
public:
  ...
  */
  ...
  /** \details
    ...
    \sa
    <link OdDbGraph::addEdge@OdDbGraphNode*@OdDbGraphNode*, OdDbGraph::addEdge() method>
  */
  void addRefTo(
    OdDbGraphNode* pTo);
...
public:
  ...
  */
  ...
  /** \details
    Adds the specified GraphNode object to this Graph object.
...
protected:
  /** \details
    ...
    \sa
    <link OdDbGraph::breakCycleEdge@OdDbGraphNode*@OdDbGraphNode*, breakCycleEdge() method>
  */
  void clearAllCycles();
private:
  OdDbGraph(
