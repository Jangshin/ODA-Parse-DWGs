...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgDefaultTextStyleXAttribute : public OdDgXAttribute
{
public:
  ODRX_DECLARE_MEMBERS(OdDgDefaultTextStyleXAttribute);

  enum { kType = 0x586B0001 };

  virtual void readData(const OdBinaryData& data, OdDgDatabase* pDb = 0) = 0;
  virtual void writeData(OdBinaryData& data) const = 0;

  virtual OdDgTextStyleTableRecordPtr getDefaultTextStyle() const = 0;
  virtual void setDefaultTextStyle(const OdDgTextStyleTableRecordPtr& pTextStyle) = 0;
};

/** \details
This template class is a specialization of the OdSmartPtr class for OdDgDefaultTextStyleXAttribute object pointers.
*/
typedef OdSmartPtr<OdDgDefaultTextStyleXAttribute> OdDgDefaultTextStyleXAttributePtr;
...
public:
  OdDgXMLNode();
  OdDgXMLNode( const OdDgXMLNode& obj);
  OdDgXMLNode( const OdString& strNodeName );

  OdDgXMLNode& operator=(const OdDgXMLNode& obj);
  ...
  void                   addTextNode(const OdString& strName, const OdString strValue);
  void                   addTextNode(const OdString& strName, OdDgXMLProperty propValue);
  ...
  void                   setText(const OdString& strText);
...
private:
  std::list<OdDgXMLProperty> m_listProperties;
  OdString                   m_strName;
  OdString                   m_strText;
};
...
public:
  OdDgXMLProperty();
  OdDgXMLProperty( const OdDgXMLProperty& obj );
  OdDgXMLProperty( const OdString& strName );
  OdDgXMLProperty( const OdString& strName, const OdString& strValue );
  OdDgXMLProperty( const OdString& strName, double dValue, OdUInt32 uPrecision = 6 ); // 1e-6
  OdDgXMLProperty( const OdString& strName, OdInt32 iValue );
  OdDgXMLProperty( const OdString& strName, OdUInt32 uValue );
  OdDgXMLProperty( const OdString& strName, OdInt64 iValue);
  OdDgXMLProperty( const OdString& strName, OdUInt64 uValue);
  OdDgXMLProperty( const OdString& strName, OdTimeStamp timeVal);
  OdDgXMLProperty( const OdString& strName, bool bValue, const OdString& strTrue = L"true", const OdString& strFalse = L"false" );
  OdDgXMLProperty( const OdString& strName, const OdGePoint2d& pt2dValue );
  OdDgXMLProperty( const OdString& strName, const OdGePoint3d& pt3dValue );
  OdDgXMLProperty( const OdDgXMLNode& xmlNode );

  OdDgXMLProperty& operator=(const OdDgXMLProperty& obj);

  OdString     getName()   const;
  OdString     asString()  const;
  OdString     asUtf16String()  const;
  double       asDouble()  const;
  OdInt32      asInt32()   const;
  OdUInt32     asUInt32()  const;
  OdInt64      asInt64()   const;
  OdUInt64     asUInt64()  const;
  OdTimeStamp  asDateTime() const;
  ...
  void         setUInt64(OdUInt64 uValue);
...
<group OdDg_Classes>
*/
class TG_EXPORT OdDgLightExtraDataXAttribute : public OdDgProcessedXmlXAttribute
{
public:
  ODRX_DECLARE_MEMBERS(OdDgLightExtraDataXAttribute);

  enum { kType = 0x58790000 };
};

/** \details
This template class is a specialization of the OdSmartPtr class for OdDgLightExtraDataXAttribute object pointers.
*/
typedef OdSmartPtr<OdDgLightExtraDataXAttribute> OdDgLightExtraDataXAttributePtr;
...
public:
  ...
  OdDgBECXMLVariant()
  {
    ...
    m_varInt64 = 0;
    m_varDouble = 0.0;
    m_varBinaryData.clear();
    m_varString = OdString::kEmpty;
  }

  virtual ~OdDgBECXMLVariant(){};

  static OdDgBECXMLVariant createBoolValue( bool value )
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags  = OdDgBECXMLVariant::kBool;
    retVal.m_varBool = value;
    return retVal;
  }

  static OdDgBECXMLVariant createByteValue(OdUInt8 value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kByte;
    retVal.m_varByte = value;
    return retVal;
  }

  static OdDgBECXMLVariant createShortValue(OdInt16 value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kShort;
    retVal.m_varShort = value;
    return retVal;
  }

  static OdDgBECXMLVariant createInt32Value(OdInt32 value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kInt32;
    retVal.m_varInt32 = value;
    return retVal;
  }

  static OdDgBECXMLVariant createInt64Value(OdInt64 value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kInt64;
    retVal.m_varInt64 = value;
    return retVal;
  }

  static OdDgBECXMLVariant createDoubleValue(double value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kDouble;
    retVal.m_varDouble = value;
    return retVal;
  }

  static OdDgBECXMLVariant createStringValue(const OdString& value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kString;
    retVal.m_varString = value;
    return retVal;
  }

  static OdDgBECXMLVariant createPoint3dValue(const OdGePoint3d& value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kPoint3d;
    retVal.m_varPoint3d = value;
    return retVal;
  }

  static OdDgBECXMLVariant createDateTimeValue(const OdTimeStamp& value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kDateAndTime;
    retVal.m_varDateTime = value;
    return retVal;
  }

  static OdDgBECXMLVariant createBinDataValue(const OdBinaryData& value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kBinary;
    retVal.m_varBinaryData = value;
    return retVal;
  }

  static OdDgBECXMLVariant createStringArrayValue(const OdArray<OdString>& value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kStringArray;
    retVal.m_varStringArray = value;
    return retVal;
  }

  static OdDgBECXMLVariant createBoolArrayValue(const OdArray<bool>& value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kBoolArray;
    retVal.m_varBoolArray = value;
    return retVal;
  }

  static OdDgBECXMLVariant createByteArrayValue(const OdArray<OdInt8>& value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kByteArray;
    retVal.m_varByteArray = value;
    return retVal;
  }

  static OdDgBECXMLVariant createShortArrayValue(const OdArray<OdInt16>& value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kShortArray;
    retVal.m_varShortArray = value;
    return retVal;
  }

  static OdDgBECXMLVariant createInt32ArrayValue(const OdArray<OdInt32>& value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kInt32Array;
    retVal.m_varInt32Array = value;
    return retVal;
  }

  static OdDgBECXMLVariant createInt64ArrayValue(const OdArray<OdInt64>& value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kInt64Array;
    retVal.m_varInt64Array = value;
    return retVal;
  }

  static OdDgBECXMLVariant createDoubleArrayValue(const OdArray<double>& value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kDoubleArray;
    retVal.m_varDoubleArray = value;
    return retVal;
  }

  static OdDgBECXMLVariant createPoint3dArrayValue(const OdArray<OdGePoint3d>& value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kPoint3dArray;
    retVal.m_varPoint3dArray = value;
    return retVal;
  }

  static OdDgBECXMLVariant createDateTimeArrayValue(const OdArray<OdTimeStamp>& value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kDateTimeArray;
    retVal.m_varDateTimeArray = value;
    return retVal;
  }

  static OdDgBECXMLVariant createBinDataArrayValue(const OdArray<OdBinaryData>& value)
  {
    OdDgBECXMLVariant retVal;
    retVal.m_uFlags = OdDgBECXMLVariant::kBinaryDataArray;
    retVal.m_varBinaryDataArray = value;
    return retVal;
  }
...
public:
  ...
  OdArray<OdBinaryData>           m_varBinaryDataArray;
};
...
public:
  ...
  virtual void  setRootNode( const OdDgBinXMLNode* pRootNode ) = 0;
...
public:
  ...
  virtual OdString getItemLibraryVersion() const = 0;
  virtual void     setItemLibraryVersion(const OdString& strVersion) = 0;
...
/** \details
  ...
  <group OdDg_Classes>
*/
class OdDgRelationshipNode;
typedef OdSmartPtr<OdDgRelationshipNode> OdDgRelationshipNodePtr;
...
/** \details
    ...
    <group OdDg_Classes>
*/
class TG_EXPORT OdDgRelationshipNode : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdDgRelationshipNode);

  enum OdDgRelationshipNodeType
  {
      kProxyNode           = 0x00
    , kElementIdNode       = 0x01
    , kElementIdExtNode    = 0x02
    , kFarElementIdNode    = 0x03
    , kFarElementIdExtNode = 0x04
  };

  virtual OdDgRelationshipNodeType getType() const = 0;

  virtual OdBinaryData getProxyData(OdUInt16 uFlags) const = 0;
  virtual bool         setProxyData(const OdBinaryData& binData, OdUInt16 uFlags, bool bSizeUnknown = true ) = 0;

  virtual bool         getUseHandlerNameFlag() const = 0;
  virtual bool         getUseObjectNameFlag() const = 0;
  virtual bool         getUseExtendedDataFlag() const = 0;
  virtual bool         getUseExtendedData2Flag() const = 0;

  virtual bool         getUseUInt32IdFormatFlag() const = 0;
  virtual void         setUseUInt32IdFormatFlag( bool bSet ) = 0;

  virtual OdString     getHandlerName() const = 0;
  virtual void         setHandlerName(const OdString& strName) = 0;

  virtual OdString     getObjectName() const = 0;
  virtual void         setObjectName(const OdString& strName) = 0;

  virtual OdUInt32     getExtendedUInt32Value() const = 0;
  virtual void         setExtendedUInt32Value(OdUInt32 uValue) = 0;

  virtual OdUInt32     getExtendedUInt64Value() const = 0;
  virtual void         setExtendedUInt64Value(OdUInt64 uValue) = 0;

  virtual OdString     getExtendedString() const = 0;
  virtual void         setExtendedString(const OdString& strExt) = 0;

  static OdDgRelationshipNodePtr createObject(OdDgRelationshipNodeType type, OdUInt16 uFlags);
  static OdDgRelationshipNodePtr createObject(OdUInt16 uFlags, const OdBinaryData& binData, bool bUnknownSize = true);
};
...
/** \details
    ...
    <group OdDg_Classes>
*/
class TG_EXPORT OdDgRelationshipElementIdNode : public OdDgRelationshipNode
{
public:
  ODRX_DECLARE_MEMBERS(OdDgRelationshipElementIdNode);

  virtual OdUInt64 getElementId() const = 0;
  virtual void     setElementId( OdUInt64 uElmId ) = 0;
};

typedef OdSmartPtr<OdDgRelationshipElementIdNode> OdDgRelationshipElementIdNodePtr;
...
/** \details
    ...
    <group OdDg_Classes>
*/
class TG_EXPORT OdDgRelationshipElementIdExtNode : public OdDgRelationshipNode
{
public:
  ODRX_DECLARE_MEMBERS(OdDgRelationshipElementIdExtNode);

  virtual OdUInt32 getIndex() const = 0;
  virtual void     setIndex(OdUInt32 uIndex) = 0;

  virtual OdUInt64 getElementId() const = 0;
  virtual void     setElementId(OdUInt64 uElmId) = 0;
};

typedef OdSmartPtr<OdDgRelationshipElementIdExtNode> OdDgRelationshipElementIdExtNodePtr;
...
/** \details
    ...
    <group OdDg_Classes>
*/
class TG_EXPORT OdDgRelationshipFarElementIdNode : public OdDgRelationshipNode
{
public:
  ODRX_DECLARE_MEMBERS(OdDgRelationshipFarElementIdNode);

  virtual OdUInt64 getXRefId() const = 0;
  virtual void     setXRefId(OdUInt64 uId) = 0;
...
typedef OdSmartPtr<OdDgRelationshipFarElementIdNode> OdDgRelationshipFarElementIdNodePtr;
...
/** \details
    ...
    <group OdDg_Classes>
*/
class TG_EXPORT OdDgRelationshipFarElementIdExtNode : public OdDgRelationshipNode
{
public:
  ODRX_DECLARE_MEMBERS(OdDgRelationshipFarElementIdExtNode);

  virtual OdUInt32 getXRefIndex() const = 0;
  virtual void     setXRefIndex(OdUInt32 uIndex) = 0;
...
typedef OdSmartPtr<OdDgRelationshipFarElementIdExtNode> OdDgRelationshipFarElementIdExtNodePtr;
...
/** \details
    ...
    <group OdDg_Classes>
*/
class TG_EXPORT OdDgRelationshipProxyNode : public OdDgRelationshipNode
{
public:
  ODRX_DECLARE_MEMBERS(OdDgRelationshipProxyNode);

  virtual OdUInt32     getSubNodeCount() const = 0;
  virtual void         setSubNodeCount(OdUInt32 uCount) = 0;
};

typedef OdSmartPtr<OdDgRelationshipProxyNode> OdDgRelationshipProxyNodePtr;
...
/** \details
    ...
    <group OdDg_Classes>
*/
class TG_EXPORT OdDgECRelationshipXAttribute : public OdDgXAttribute
{
public:

  enum { kType = 0x57160001 };

  enum OdDgECRelationshipType
  {
    kSource = 0,
    kTarget = 1
  };
...
public:
  ...
  ODRX_DECLARE_MEMBERS(OdDgECRelationshipXAttribute);
  ...
  virtual bool     getExtDataFlag() const = 0;
  virtual void     setExtDataFlag(bool bSet) = 0;

  virtual bool     getRecordSizeFlag() const = 0;
  virtual void     setRecordSizeFlag(bool bSet) = 0;

  virtual bool     getECSchemaIdFlag() const = 0;
  virtual void     setECSchemaIdFlag(bool bSet) = 0;

  virtual bool     getExtData2Flag() const = 0;
  virtual void     setExtData2Flag(bool bSet) = 0;

  virtual bool     getObjectNameStrFlag() const = 0;
  virtual void     setObjectNameStrFlag(bool bSet) = 0;

  virtual OdUInt32 getHeaderXAttrId() const = 0;
  virtual void     setHeaderXAttrId(OdUInt32 uXAttrId) = 0;

  // Header

  virtual OdString getECSchemaName() const = 0;
  virtual void     setECSchemaName(const OdString& strName) = 0;

  virtual OdUInt32 getECSchemaVersion() const = 0;
  virtual void     setECSchemaVersion(OdUInt32 uVersion) = 0;

  virtual OdUInt32 getECSchemaSubVersion() const = 0;
  virtual void     setECSchemaSubVersion(OdUInt32 uSubVersion) = 0;

  virtual OdUInt64 getECSchemaId() const = 0;
  virtual void     setECSchemaId(OdUInt64 uId) = 0;

  virtual OdString getECRelationshipClassName() const = 0;
  virtual void     setECRelationshipClassName(const OdString& strName) = 0;

  virtual OdDgECRelationshipType  getRelationshipType() const = 0;
  virtual void     setRelationshipType(OdDgECRelationshipType uMode ) = 0;
  ...
  virtual OdUInt32 getRealtionshipNodeCount() const = 0;
  virtual OdDgRelationshipNodePtr getRelationshipNode( OdUInt32 uIndex ) const = 0;
  virtual void     setRelationshipNode( OdUInt32 uIndex, const OdDgRelationshipNodePtr& pNode) = 0;
  virtual void     addRelationshipNode(const OdDgRelationshipNodePtr& pNode) = 0;
  virtual void     daleteRelationshipNode(OdUInt32 uIndex) = 0;
};

/** \details
This template class is a specialization of the OdSmartPtr class for OdDgECRelationshipXAttribute object pointers.
*/
typedef OdSmartPtr<OdDgECRelationshipXAttribute> OdDgECRelationshipXAttributePtr;
...
/** \details
This template class is a specialization of the OdSmartPtr class for OdDgRasterClipXAttribute object pointers.
*/
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgPdfLayerVisibilityDifXAttribute : public OdDgXAttribute
{
public:

  enum { kType = 0x570B0007 };

public:

  ODRX_DECLARE_MEMBERS(OdDgPdfLayerVisibilityDifXAttribute);

  virtual void readData(const OdBinaryData& data, OdDgDatabase* pDb = 0) = 0;
  virtual void writeData(OdBinaryData& data) const = 0;

  virtual OdUInt32 getLayerDifCount() const = 0;
  virtual void     getLayerDifStatus( OdUInt32 uIndex, OdUInt32& uLayerIndex, bool& bVisible ) = 0;
  virtual void     setLayerDifStatus( OdUInt32 uLayerIndex, bool bVisible ) = 0;
  virtual void     deleteLayerDifStatus( OdUInt32 uLayerIndex ) = 0;
};

/** \details
This template class is a specialization of the OdSmartPtr class for OdDgPdfLayerVisibilityDifXAttribute object pointers.
*/
typedef OdSmartPtr<OdDgPdfLayerVisibilityDifXAttribute> OdDgPdfLayerVisibilityDifXAttributePtr;
...
/** \details
    ...
    <group OdDg_Classes>
*/
class TG_EXPORT OdDgAcsXAttribute : public OdDgXAttribute
{
public:
  ODRX_DECLARE_MEMBERS(OdDgAcsXAttribute);
  ...
  virtual bool          getViewIndependentFlag() const = 0;
  virtual void          setViewIndependentFlag( bool bSet ) = 0;

  virtual OdDgModel::AcsType getAcsType() const = 0;
  virtual void          setAcsType( const OdDgModel::AcsType& uType ) = 0;

  virtual OdUInt64      getAcsElementId() const = 0;
  virtual void          setAcsElementId( OdUInt64 uId ) = 0;

  virtual bool          getExtraDataFlag() const = 0;
  virtual void          setExtraDataFlag( bool bSet ) = 0;

  virtual OdBinaryData  getExtraData() const = 0;
  virtual void          setExtraData( OdBinaryData& binData ) = 0;

  enum { kType = 0x57170001 };
};

/** \details
    This template class is a specialization of the OdSmartPtr class for OdDgAcsXAttribute object pointers.
*/
typedef OdSmartPtr<OdDgAcsXAttribute> OdDgAcsXAttributePtr;
...
public:
  ...
  void     setMaterialId( OdUInt64 uEntryId );
...
public:
  ...
  enum OdDgExtendedElementType
  {
    ...
    kKMLPlacemarkElement            = 0x006E0000,
...
public:
  ...
  virtual const       OdGePoint3dArray& getVertices() const = 0;
};
...
public:
  ...
  virtual const OdArray<OdDgTerrainEdgeOneDirectionRecord>* getEdgeDirectionArrayPtr() const = 0;
...
public:
  ...
  virtual DWGHatchLine getDwgHatchLine( OdUInt32 uIndex ) const = 0;
  virtual void     setDwgHatchLine( OdUInt32 uIndex, const DWGHatchLine& hatchLine ) = 0;
  virtual void     addDwgHatchLine( const DWGHatchLine& hatchLine ) = 0;
...
/** \details
  ...
  <group OdDg_Classes>
*/
class OdDgElementSchema;
typedef OdSmartPtr<OdDgElementSchema> OdDgElementSchemaPtr;
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgElementSchema : public OdRxObject
{
public:

  enum OdDgElementSchemaType
  {
      kTableData                  = 0x00
    , kCellData                   = 0x01
    , kColumnData                 = 0x02
...
public:
  ODRX_DECLARE_MEMBERS(OdDgElementSchema);

  virtual OdDgElementSchemaType getType() const = 0;
  ...
  static OdDgElementSchemaPtr createObject( OdDgElementSchemaType type, const OdBinaryData& binData );
  static OdDgElementSchemaPtr createObject(const OdDgPrototypeElementPtr& pPrototype, OdUInt32 uShemaIndex, const OdBinaryData& binData);
};
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgPrototypeBasedElementSchema : public OdDgElementSchema
{
public:
  ODRX_DECLARE_MEMBERS( OdDgPrototypeBasedElementSchema );
  ...
  virtual bool     isDataSymchronized(const OdDgPrototypeElementPtr& pPrototype) const = 0;

  virtual bool     loadFromPrototype( const OdDgPrototypeElementPtr& pPrototype, const OdBinaryData& binData ) = 0;
  virtual bool     synchronizeDataWithPrototype(const OdDgPrototypeElementPtr& pPrototype) = 0;
  ...
  virtual bool     getSchemaItem( const OdString& strItemName, OdDgSchemaItemVariant& schemaItem ) const = 0;
  virtual void     setSchemaItem( const OdDgSchemaItemVariant& item ) = 0;
  virtual bool     hasSchemaItem( const OdString& strItemName ) const = 0;
};

typedef OdSmartPtr<OdDgPrototypeBasedElementSchema> OdDgPrototypeBasedElementSchemaPtr;
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgProxyTableElementSchema : public OdDgElementSchema
{
public:
  ODRX_DECLARE_MEMBERS( OdDgProxyTableElementSchema );

  virtual void setType( const OdDgElementSchema::OdDgElementSchemaType& uType ) = 0;
};
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgTableDataTableElementSchema : public OdDgPrototypeBasedElementSchema
{
public:
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgMergeDataTableElementSchema : public OdDgPrototypeBasedElementSchema
{
public:
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgFillTableElementSchema : public OdDgPrototypeBasedElementSchema
{
public:
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgSymbologyTableElementSchema : public OdDgPrototypeBasedElementSchema
{
public:
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgEdgeRunTableElementSchema : public OdDgPrototypeBasedElementSchema
{
public:
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgRowTableElementSchema : public OdDgPrototypeBasedElementSchema
{
public:
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgColumnTableElementSchema : public OdDgPrototypeBasedElementSchema
{
public:
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgCellTableElementSchema : public OdDgPrototypeBasedElementSchema
{
public:
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgTablePrototypeDescriptionSchema : public OdDgElementSchema
{
public:
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgTablePrototypeHeaderSchema : public OdDgElementSchema
{
public:
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgTablePrototypeItemSchema : public OdDgElementSchema
{
public:
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgTableSnippedTextSchema : public OdDgPrototypeBasedElementSchema
{
public:
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgPCMCellSchema : public OdDgPrototypeBasedElementSchema
{
public:
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgPCMCellDefSchema : public OdDgPrototypeBasedElementSchema
{
public:
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgElementSchemaXAttribute : public OdDgXAttribute
{
public:
...
public:
  ...
  ODRX_DECLARE_MEMBERS(OdDgElementSchemaXAttribute);
  ...
  virtual OdUInt16 getSchemaIndex() const = 0;
  virtual void     setSchemaIndex(OdUInt16 uIndex) = 0;

  virtual OdDgElementSchemaPtr getSchema( OdDgDatabase* pDb ) const = 0;
  virtual void setSchema( const OdDgElementSchemaPtr& pSchema ) = 0;
};

/** \details
This template class is a specialization of the OdSmartPtr class for OdDgElementSchemaXAttribute object pointers.
*/
typedef OdSmartPtr<OdDgElementSchemaXAttribute> OdDgElementSchemaXAttributePtr;
...
/** \details
  ...
  <group OdDg_Classes>
*/
class TG_EXPORT OdDgKMLPlacemarkXAttribute : public OdDgXAttribute
{
public:
  ODRX_DECLARE_MEMBERS(OdDgKMLPlacemarkXAttribute);

  enum { kType = 0x57190000 };

  virtual void readData(const OdBinaryData& data, OdDgDatabase* pDb = 0) = 0;
  virtual void writeData(OdBinaryData& data) const = 0;

  virtual bool getActivePlacemarkFlag() const = 0;
  virtual void   setActivePlacemarkFlag(bool bSet) = 0;
};

/** \details
This template class is a specialization of the OdSmartPtr class for OdDgKMLPlacemarkXAttribute object pointers.
*/
typedef OdSmartPtr<OdDgKMLPlacemarkXAttribute> OdDgKMLPlacemarkXAttributePtr;
