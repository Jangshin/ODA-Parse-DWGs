...
typedef OdSmartPtr<OdDgFunctionOperator> OdDgFunctionOperatorPtr;
...
typedef OdSmartPtr<OdDgSpecialConstant> OdDgSpecialConstantPtr;
...
public:
  ...
  virtual void setExpression(const OdDgExpressionItemPtr& pExpression ) = 0;
...
class TG_EXPORT OdDgVariable : public OdDgElement
{
  ...
  public:
    ...
    virtual bool                      setExpression( const OdDgExpressionVariablePtr& pExpression );
...
public:
  ...
  virtual OdDgECClassInstancePtr getItemTypeInstance() const;
  virtual bool                   setItemTypeInstance( const OdDgECClassInstancePtr& pInstance );
...
public:
  ...
  virtual OdDgECClassInstancePtr getItemTypeDefaults() const;
  virtual bool                   setItemTypeDefaults( const OdDgECClassInstancePtr& pDefaults );
