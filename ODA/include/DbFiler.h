...
public:
  ...
  */
  ...
  /** \details
    Returns the double value of the current item of this Filer object.
    By default, if the value is not a valid IEEE double then this function returns 0.0
  */
  virtual double rdDouble() = 0;

  /** \details
    Returns the double value of the current item of this Filer object.
    No validity checks are done, may return infinities or other invalid values
  */
  ...
  */
  ...
  /** \details
  Indicates whether the filer object is used to store/read the revision control format.
  
  \returns The true value if the filer object is used to store/read the revision control format, or false otherwise.
