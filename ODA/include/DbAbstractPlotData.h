...
class TOOLKIT_EXPORT OdDbAbstractPlotData : public OdRxObject
{
  public:
    ...
    */
    ...
    /** \details
      Returns true if and only if lineweights plotting enabled for this Plot object.
    */
    virtual bool plotLineweights(const OdRxObject* pPlotObj) const = 0;

    /** \details
      Controls lineweights plotting for this Plot object.
      \param pPlotObj [in]  Pointer to the Plot object.
      \param bEnable [in]  New lineweights plotting setting.
    */
    virtual void setPlotLineweights(OdRxObject* pPlotObj, bool bEnable) const = 0;
