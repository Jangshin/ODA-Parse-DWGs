...
public:
  ...
  */
  ...
  /** \details
    ...
    \param clazz [in] Subentity RX class.
    \param index [in] Subentity index.
  */
  ...
  */
  ...
  {
    return ((m_Index == subentId.m_Index) && (m_Type == subentId.m_Type) && (m_Class == subentId.m_Class));
  }
  ...
  */
  ...
  { 
    m_Type = type; 
    if (m_Type != OdDb::kClassSubentType)
      m_Class = OdString::kEmpty;
  }
  ...
  */
  ...
  /** \details
    ...
    \returns RX class of this SubentId object.
  */
  OdRxClass* typeClass() const
  { 
    return ::odrxGetClassDesc(m_Class); 
  }
