...
/** \details
    <group OdEd_Classes>
*/
class TOOLKIT_EXPORT OdEdSSetTracker : public OdSSetTracker
{
public:
  ...
  */
  ...
  /** \details
    ...
    \param id [in]  object id of the entity going to be appended.
  ...
  */
  ...
  /** \details
    ...
    \param id [in]  object id of the entity going to be removed.
    \param pMethod [in]  Selection Method object, describing a method the entity was selected. 
  ...
  */
  ...
  /** \details
    ...
    \param subEntPath [in]  Descriptor of the subentity going to be appended.
  ...
  */
  ...
  /** \details
    ...
    \param subEntPath [in]  Descriptor of the subentity going to be removed.
    \param pMethod [in]  Selection Method object, describing a method a subentity was selected. 
