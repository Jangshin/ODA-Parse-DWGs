...
public:
  ...
  */
  ...
  /** \details
    Returns an iterator that points at the beginning of the record.
    To be used to traverse through entries via "range-based for" loop.
  */
  OdDbNextIteratorWrap<OdDbXrecordIterator> begin() const {
    return OdDbNextIteratorWrap<OdDbXrecordIterator>(newIterator());
  }

  /** \details
    Returns an iterator that points at the end of the record,
    to support "range-based for" loop.
  */
  OdDbNextIteratorWrap<OdDbXrecordIterator> end() const {
    return OdDbNextIteratorWrap<OdDbXrecordIterator>(OdDbXrecordIteratorPtr());
  }
