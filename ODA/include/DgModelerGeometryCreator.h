...
public:  
  ...
  */
  virtual OdResult createModeler(OdArray<OdDgModelerGeometryPtr> &models, 
    OdStreamBuf* pStreamBuf, OdDbBaseDatabase* pDb = NULL, bool bAcis = false ) = 0;
  ...
  */
  ...
  virtual OdResult initBrepBuilder(OdBrepBuilder& brepBuilder, BrepType brepType, bool bAcis = true) = 0;
};
